...
$site = Functions::site();
$title = 'Ремонт ветеринарной клиники под ключ — цены 2026 | Проект Квартира';
...
<head>
    ...
    <meta name="description" content="Ремонт ветеринарной клиники под ключ. Гидроизоляция, вентиляция, зонирование по санитарным нормам. Цены от 10 000 ₽/м². Гарантия 3 года. От компании Проект Квартира (ПКвартира)."><meta name="robots" content="index, follow">
    <link rel="canonical" href="<?= htmlspecialchars($site['baseUrl'] . '/services/vetklinika'); ?>">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            {"@type": "BreadcrumbList","itemListElement": [
                ...
                {"@type": "ListItem","position": 2,"name": "Ремонт ветклиники","item": "<?= $site['baseUrl']; ?>/services/vetklinika"}
            ]},
            {"@type": "Service","name": "Ремонт ветеринарной клиники под ключ","provider": {"@type": "Organization","name": "Проект Квартира","alternateName": "ПКвартира","brand": "Проект Квартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
...
<main class="pt-20" style="padding-top:80px">
    <section class="relative bg-[#1f2937] text-white">
        ...
        <div class="relative container mx-auto px-4 max-w-6xl py-14 md:py-20">
            <h1 class="text-[28px] md:text-[40px] font-extrabold leading-tight" style="font-family:var(--font-heading)">Ремонт ветеринарной клиники</h1>
            <p class="mt-4 text-[17px] text-gray-300 max-w-2xl">Профессиональный ремонт ветеринарных клиник под ключ. Гидроизоляция, вентиляция, зонирование по санитарным нормам.</p>
            <div class="mt-6 flex flex-wrap gap-4">
                ...
                <div class="flex items-center gap-2 text-sm text-gray-300"><span class="w-5 h-5 rounded-full bg-orange-500 flex items-center justify-center text-[10px]">✓</span> Санитарные нормы</div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h2 class="text-2xl font-bold text-[#111827]" style="font-family:var(--font-heading)">Ремонт ветеринарной клиники под ключ</h2>
                    <p class="mt-4 text-[#4b5563] leading-relaxed">Выполняем ремонт ветеринарных клиник с учётом всех санитарных норм. Гидроизоляция полов и стен, система вентиляции, правильное зонирование приёмных, операционных и стационаров.</p>
                    <ul class="mt-4 space-y-2">
                        ...
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Зонирование по санитарным нормам</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Монтаж медицинского оборудования</li>
                    </ul>
                </div>
                <div class="bg-[#f9fafb] rounded-xl p-6">
                    <h3 class="text-lg font-bold text-[#111827]">Цены на ремонт ветклиники</h3>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="max-w-lg mx-auto">
                <?php
$ctaFormId = 'vetklinika_cta';
$ctaFormTitle = 'Рассчитать стоимость ремонта ветклиники';
...
?>
    ...
    <section class="py-12 bg-[#f9fafb]">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-6 max-w-3xl mx-auto space-y-3">
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Выполняете ли вы гидроизоляцию в ветклинике?</summary><p class="mt-2 text-sm text-[#6b7280]">Да, выполняем полную гидроизоляцию полов и стен с использованием специальных составов для медицинских учреждений.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Помогаете ли вы с согласованием с Роспотребнадзором?</summary><p class="mt-2 text-sm text-[#6b7280]">Да,我们提供 полное сопровождение по согласованию с контролирующими органами.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Сколько времени занимает ремонт ветклиники?</summary><p class="mt-2 text-sm text-[#6b7280]">Сроки от 3 недель до 3 месяцев в зависимости от площади и объёма работ.</p></details>
            </div>
        </div>
    </section>
</main>
    <section class="py-12 text-center bg-white">
        ...
        <!-- Финальный CTA -->
        <?php
        $ctaFormId = 'vetklinika_bottom_cta';
        $ctaFormTitle = 'Рассчитать стоимость ремонта';
        $ctaFormSubtitle = 'Бесплатный расчёт за 5 минут';
        $ctaButtonText = 'Получить расчёт бесплатно';
        $ctaExpandable = false;
        $ctaSectionBadge = 'Бесплатный расчёт';
        $ctaSectionHeading = 'Готовы рассчитать стоимость: ремонт ветеринарной клиники под ключ';
