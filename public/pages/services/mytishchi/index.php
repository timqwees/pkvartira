...
$site = Functions::site();
$title = 'Ремонт квартир в Мытищах — цены под ключ, гарантия 3 года | ПКвартира';
...
<head>
    ...
    <meta name="description" content="Ремонт квартир в Мытищах под ключ. Цены от 8 000 ₽/м². Косметический, капитальный, дизайнерский ремонт. Фиксированная смета, гарантия 3 года. Замер и смета в Мытищах бесплатно.">
    <meta name="keywords" content="ремонт квартир Мытищи, ремонт под ключ в Мытищах, отделка квартир в Мытищах, ремонт квартир в Мытищи цены">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            ...
            {"@type": "Service","name": "Ремонт квартир в Мытищах","provider": {"@type": "Organization","name": "ПКвартира"},"areaServed": {"@type": "City","name": "Мытищи"}}
        ]
    }
    </script>
</head>
