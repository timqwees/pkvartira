...
$site = Functions::site();
$title = 'Ремонт квартиры комфорт класса — цены 2026 | Проект Квартира';
...
<head>
    ...
    <meta name="description" content="Ремонт квартиры комфорт класса в Москве — цены от 10 000 ₽/м². Оптимальное соотношение цены и качества. Фиксированная смета, гарантия 3 года. От компании Проект Квартира (ПКвартира)."><meta name="robots" content="index, follow">
    <link rel="canonical" href="<?= htmlspecialchars($site['baseUrl'] . '/services/komfort'); ?>">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            {"@type": "BreadcrumbList","itemListElement": [
                ...
                {"@type": "ListItem","position": 2,"name": "Ремонт комфорт класса","item": "<?= $site['baseUrl']; ?>/services/komfort"}
            ]},
            {"@type": "Service","name": "Ремонт квартиры комфорт класса","provider": {"@type": "Organization","name": "Проект Квартира","alternateName": "ПКвартира","brand": "Проект Квартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
...
<main class="pt-20" style="padding-top:80px">
    <section class="relative bg-[#1f2937] text-white">
        ...
        <div class="relative container mx-auto px-4 max-w-6xl py-14 md:py-20">
            <h1 class="text-[28px] md:text-[40px] font-extrabold leading-tight" style="font-family:var(--font-heading)">Ремонт квартиры комфорт класса</h1>
            <p class="mt-4 text-[17px] text-gray-300 max-w-2xl">Оптимальное соотношение цены и качества для ремонта квартиры в Москве. Качественные материалы, современная отделка, гарантия 3 года.</p>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h2 class="text-2xl font-bold text-[#111827]" style="font-family:var(--font-heading)">Ремонт квартиры комфорт класса под ключ</h2>
                    <p class="mt-4 text-[#4b5563] leading-relaxed">Выполняем ремонт квартир комфорт класса в Москве под ключ. Оптимальный выбор для тех, кто хочет качественную отделку по разумной цене. Современные материалы, аккуратное исполнение.</p>
                    <ul class="mt-4 space-y-2">
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Оптимальное соотношение цены и качества</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Современные материалы среднего сегмента</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Замена электрики и сантехники</li>
                ...
                <div class="bg-[#f9fafb] rounded-xl p-6">
                    <h3 class="text-lg font-bold text-[#111827]">Цены на ремонт комфорт</h3>
                    <div class="mt-4 space-y-3">
                        <div class="flex justify-between items-center py-2 border-b border-gray-200"><span class="text-[#4b5563]">Комфорт</span><span class="font-bold text-[#111827]">от 10 000 ₽/м²</span></div>
                        <div class="flex justify-between items-center py-2"><span class="text-[#4b5563]">Комфорт+</span><span class="font-bold text-[#111827]">от 13 000 ₽/м²</span></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-12 bg-[#f9fafb]">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-6 max-w-3xl mx-auto space-y-3">
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Что входит в ремонт комфорт класса?</summary><p class="mt-2 text-sm text-[#6b7280]">Замена электрики и сантехники, стяжка полов, штукатурка стен, чистовая отделка, установка дверей и откосов, финальная уборка.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Чем комфорт отличается от эконом?</summary><p class="mt-2 text-sm text-[#6b7280]">Комфорт класс использует более качественные материалы, включает полную замену инженерных систем и более широкий выбор отделки.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Сколько времени занимает ремонт?</summary><p class="mt-2 text-sm text-[#6b7280]">Сроки зависят от площади и объёма работ. В среднем от 3 до 8 недель. Точные сроки фиксируются в договоре.</p></details>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 text-center bg-white">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-4 flex flex-wrap justify-center gap-3">
                ...
                <a href="/services/econom" class="px-4 py-2 rounded-lg bg-white border border-gray-200 text-sm text-[#4b5563] hover:border-orange-500">Эконом класс</a>
        ...
        <!-- Финальный CTA -->
        <?php
        $ctaFormId = 'komfort_bottom_cta';
        $ctaFormTitle = 'Рассчитать стоимость ремонта';
        $ctaFormSubtitle = 'Бесплатный расчёт за 5 минут';
        $ctaButtonText = 'Получить расчёт бесплатно';
        $ctaExpandable = false;
        $ctaSectionBadge = 'Бесплатный расчёт';
        $ctaSectionHeading = 'Готовы рассчитать стоимость: ремонт квартиры комфорт класса';
