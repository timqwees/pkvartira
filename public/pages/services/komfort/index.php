...
$site = Functions::site();
$title = 'Ремонт квартиры комфорт класса — цены 2026 | ПКвартира';
...
<head>
    ...
    <meta name="description" content="Ремонт квартиры комфорт класса в Москве — цены от 10 000 ₽/м². Оптимальное соотношение цены и качества. Фиксированная смета, гарантия 3 года.">
    <meta name="keywords" content="ремонт комфорт класса, ремонт квартиры комфорт, ремонт средней стоимости Москва, качественный ремонт недорого">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            ...
            {"@type": "Service","name": "Ремонт квартиры комфорт класса","provider": {"@type": "Organization","name": "ПКвартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
