...
$title = 'Ремонт квартир в Балашихе — цены под ключ, гарантия 3 года | Проект Квартира';
...
<head>
    ...
    <meta name="description" content="<?= htmlspecialchars(\Setting\Route\Functions\TheFunction::truncateSeo('Ремонт квартир в Балашихе под ключ. Цены от 8 000 ₽/м². Косметический, капитальный, дизайнерский ремонт. Фиксированная смета, реальные сроки, гарантия 3 года. — Проект Квартира (ПКвартира).',155)); ?>"><meta name="robots" content="index, follow">
