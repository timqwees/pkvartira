...
$seo = Setting\Route\Function\Functions::seo([
    'title' => 'Ремонт квартир в Балашихе — цены под ключ, гарантия 3 года',
    'description' => 'Ремонт квартир в Балашихе под ключ. Цены от 8 000 ₽/м². Косметический, капитальный, дизайнерский ремонт. Фиксированная смета, реальные сроки, гарантия 3 года.',
    'image' => $site['shareImageUrl'],
    'url' => $site['baseUrl'] . '/services/balashikha',
    'type' => 'website',
    'pageType' => 'Service',
    'breadcrumbs' => [
        ['name' => 'Главная', 'url' => $site['baseUrl'] . '/'],
        ['name' => 'Услуги', 'url' => $site['baseUrl'] . '/services/pod-klyuch'],
        ['name' => 'Ремонт квартир в Балашихе — цены под ключ, гарантия 3 года', 'url' => $site['baseUrl'] . '/services/balashikha'],
    ],
    'schema' => [
...
<head>
    ...
    <meta name="keywords" content="Ремонт квартир в Балашихе — цены под ключ, гарантия 3 года, balashikha, ремонт под ключ, ПКвартира, ремонт под ключ, ПКвартира">
    ...
    <main class="pt-20 flex flex-col gap-8 pb-16">
            ...
            <div class="container mx-auto px-4 max-w-4xl">
                <nav aria-label="breadcrumb" class="text-sm text-gray-600 mb-4">
                    <ol class="flex flex-wrap items-center gap-2">
                        ...
                        <li class="text-gray-400">/</li>
                        <li class="text-gray-900 font-medium">Ремонт квартир в Балашихе — цены под ключ, гарантия 3 года</li>
                    </ol>
                </nav>
                <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Ремонт квартир в Балашихе — цены под ключ, гарантия 3 года</h1>
                <p class="text-gray-600 text-lg leading-relaxed">
                    Ремонт квартир в Балашихе под ключ. Цены от 8 000 ₽/м². Косметический, капитальный, дизайнерский ремонт. Фиксированная смета, реальные сроки, гарантия 3 года.
                </p>
            </div>
        </section>
        ...
        <section class="container mx-auto px-4 max-w-4xl reveal">
            <div class="bg-white rounded-2xl border border-gray-200 p-6 md:p-8 shadow-sm">
                <h2 class="text-2xl font-bold text-gray-900 mb-4">Что входит в Ремонт квартир в Балашихе — цены под ключ, гарантия 3 года</h2>
                <p class="text-gray-600 mb-6 leading-relaxed">
                    Полный комплекс работ по ремонт квартир в балашихе — цены под ключ, гарантия 3 года под ключ. Вы получаете готовый результат без скрытых платежей и с гарантией 3 года.
                </p>
