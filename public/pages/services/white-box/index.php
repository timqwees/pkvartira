...
$site = Functions::site();
$title = 'Ремонт квартиры white box (вайт бокс) — цены 2026 | ПКвартира';
...
<head>
    ...
    <meta name="description" content="Ремонт квартиры white box (вайт бокс) в Москве. Белая коробка: стены, пол, потолок, электрика, сантехника. Цена от 8 000 ₽/м². Гарантия 3 года.">
    <meta name="keywords" content="ремонт white box, вайт бокс ремонт, белая коробка квартира, white box новостройка, ремонт под white box">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="<?= htmlspecialchars($site['baseUrl'] . '/services/white-box'); ?>">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            {"@type": "BreadcrumbList","itemListElement": [
                ...
                {"@type": "ListItem","position": 2,"name": "Ремонт White Box","item": "<?= $site['baseUrl']; ?>/services/white-box"}
            ]},
            {"@type": "Service","name": "Ремонт квартиры white box","provider": {"@type": "Organization","name": "ПКвартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
...
<main class="pt-20" style="padding-top:80px">
    <section class="relative bg-[#1f2937] text-white">
        ...
        <div class="relative container mx-auto px-4 max-w-6xl py-14 md:py-20">
            <h1 class="text-[28px] md:text-[40px] font-extrabold leading-tight" style="font-family:var(--font-heading)">Ремонт квартиры white box (вайт бокс)</h1>
            <p class="mt-4 text-[17px] text-gray-300 max-w-2xl">Белая коробка: выровненные стены, стяжка, электрика, сантехника. Готовая основа для чистового ремонта. Цена от 8 000 ₽/м². Гарантия 3 года.</p>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h2 class="text-2xl font-bold text-[#111827]" style="font-family:var(--font-heading)">Что такое white box</h2>
                    <p class="mt-4 text-[#4b5563] leading-relaxed">White box (вайт бокс) — это формат сдачи квартиры, при котором застройщик выполняет базовый набор работ: выравнивает стены, стягивает пол, разводит электрику и подводит сантехнику. Квартира готова к чистовой отделке.</p>
                    <p class="mt-4 text-[#4b5563] leading-relaxed">Формат white box экономит время и деньги на черновом этапе. Вам остаётся только чистовая отделка: обои, покраска, плитка, ламинат, установка дверей и сантехники.</p>
                    <ul class="mt-4 space-y-2">
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Выровненные штукатуркой стены под покраску или обои</li>
                        ...
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Электрика: проводка, подрозетники, вводный щиток</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Сантехника: подводка воды, канализация к точкам</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Установка входной двери и окон</li>
                    </ul>
                </div>
                <div class="bg-[#f9fafb] rounded-xl p-6">
                    <h3 class="text-lg font-bold text-[#111827]">Цены на ремонт white box</h3>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="max-w-lg mx-auto">
                <?php
$ctaFormId = 'white-box_cta';
$ctaFormTitle = 'Рассчитать стоимость ремонта white box';
    ...
    <section class="py-12 bg-[#f9fafb]">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-6 max-w-3xl mx-auto space-y-3">
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Чем white box отличается от чистовой отделки?</summary><p class="mt-2 text-sm text-[#6b7280]">White box — это подготовка основы (стены, пол, электрика, сантехника). Чистовая отделка — финишные работы поверх неё: обои, плитка, ламинат, двери.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Сколько стоит ремонт квартиры в формате white box?</summary><p class="mt-2 text-sm text-[#6b7280]">Цены от 8 000 ₽/м². Точная стоимость зависит от объёма чистовых работ и выбранных материалов. Рассчитаем смету после бесплатного замера.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Все ли застройщики сдают в формате white box?</summary><p class="mt-2 text-sm text-[#6b7280]">Нет, форматы сдачи варьируются: от голых стен до предчистовой. Уточните у застройщика, что входит в вашу квартиру.</p></details>
            </div>
        </div>
    </section>
</main>
