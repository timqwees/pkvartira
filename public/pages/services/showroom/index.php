...
$site = Functions::site();
$title = 'Ремонт шоу-рума под ключ — цены в Москве 2026 | ПКвартира';
...
<head>
    ...
    <meta name="description" content="Ремонт шоу-рума под ключ в Москве. Дизайн под фирменный стиль, витрины, зонирование. Цены от 10 000 ₽/м². Гарантия 3 года.">
    <meta name="keywords" content="ремонт шоу-рума, ремонт шоурума, дизайн шоу-рума, ремонт шоу-рума цены">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            {"@type": "BreadcrumbList","itemListElement": [
                ...
                {"@type": "ListItem","position": 2,"name": "Ремонт шоу-рума","item": "<?= $site['baseUrl']; ?>/services/showroom"}
            ]},
            {"@type": "Service","name": "Ремонт шоу-рума под ключ","provider": {"@type": "Organization","name": "ПКвартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
...
<main class="pt-20" style="padding-top:80px">
    <section class="relative bg-[#1f2937] text-white">
        ...
        <div class="relative container mx-auto px-4 max-w-6xl py-14 md:py-20">
            <h1 class="text-[28px] md:text-[40px] font-extrabold leading-tight" style="font-family:var(--font-heading)">Ремонт шоу-рума под ключ</h1>
            <p class="mt-4 text-[17px] text-gray-300 max-w-2xl">Дизайн и ремонт шоу-румов в Москве под фирменный стиль. Витрины, зонирование, привлекательная выкладка товаров.</p>
            <div class="mt-6 flex flex-wrap gap-4">
                ...
                <div class="flex items-center gap-2 text-sm text-gray-300"><span class="w-5 h-5 rounded-full bg-orange-500 flex items-center justify-center text-[10px]">✓</span> Дизайн под бренд</div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h2 class="text-2xl font-bold text-[#111827]" style="font-family:var(--font-heading)">Ремонт шоу-рума под ключ в Москве</h2>
                    <p class="mt-4 text-[#4b5563] leading-relaxed">Создаём шоу-румы, которые привлекают внимание и повышают продажи. Учитываем фирменный стиль бренда, разрабатываем проект зонирования, монтируем витрины и освещение.</p>
                    <ul class="mt-4 space-y-2">
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Дизайн под фирменный стиль бренда</li>
                        ...
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Зонирование пространства</li>
                ...
                <div class="bg-[#f9fafb] rounded-xl p-6">
                    <h3 class="text-lg font-bold text-[#111827]">Цены на ремонт шоу-рума</h3>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="max-w-lg mx-auto">
                <?php
$ctaFormId = 'showroom_cta';
$ctaFormTitle = 'Рассчитать стоимость ремонта шоу-рума';
    ...
    <section class="py-12 bg-[#f9fafb]">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-6 max-w-3xl mx-auto space-y-3">
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Можете ли вы разработать дизайн под наш фирменный стиль?</summary><p class="mt-2 text-sm text-[#6b7280]">Да,我们的设计师 создадут проект с учётом вашей фирменной стилистики, цветовой гаммы и корпоративного стиля.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Выполняете ли вы монтаж витрин?</summary><p class="mt-2 text-sm text-[#6b7280]">Да, монтируем витрины любой сложности, включая подсветку и декоративные элементы.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Сколько времени занимает ремонт шоу-рума?</summary><p class="mt-2 text-sm text-[#6b7280]">Сроки от 2 недель до 2 месяцев в зависимости от площади и сложности проекта.</p></details>
            </div>
        </div>
    </section>
</main>
