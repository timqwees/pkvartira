...
$site = Functions::site();
$title = 'Ремонт стоматологии под ключ — цены 2026 | ПКвартира';
...
<head>
    ...
    <meta name="description" content="Ремонт стоматологии под ключ. Вентиляция, гидроизоляция, стерилизационная, нормы Роспотребнадзора. Цены от 12 000 ₽/м². Гарантия 3 года.">
    <meta name="keywords" content="ремонт стоматологии, ремонт стоматологической клиники, ремонт стоматологии цены">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            ...
            {"@type": "Service","name": "Ремонт стоматологии под ключ","provider": {"@type": "Organization","name": "ПКвартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
