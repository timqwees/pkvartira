...
$site = Functions::site();
$title = 'Ремонт квартир в монолитном доме под ключ — цены 2026 | ПКвартира';
...
<head>
    ...
    <meta name="description" content="Ремонт квартир в монолитном доме под ключ в Москве. Прочные стены, свободная планировка, перепланировка. Косметический от 8 000 ₽/м², капитальный от 13 000 ₽/м². Гарантия 3 года.">
    <meta name="keywords" content="ремонт в монолитном доме, ремонт монолитной квартиры, перепланировка монолитного дома, ремонт монолит цены">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="<?= htmlspecialchars($site['baseUrl'] . '/services/monolit'); ?>">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            {"@type": "BreadcrumbList","itemListElement": [
                ...
                {"@type": "ListItem","position": 2,"name": "Ремонт в монолитном доме","item": "<?= $site['baseUrl']; ?>/services/monolit"}
            ]},
            {"@type": "Service","name": "Ремонт квартир в монолитном доме","provider": {"@type": "Organization","name": "ПКвартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
...
<main class="pt-20" style="padding-top:80px">
    <section class="relative bg-[#1f2937] text-white">
        ...
        <div class="relative container mx-auto px-4 max-w-6xl py-14 md:py-20">
            <h1 class="text-[28px] md:text-[40px] font-extrabold leading-tight" style="font-family:var(--font-heading)">Ремонт квартир в монолитном доме под ключ</h1>
            <p class="mt-4 text-[17px] text-gray-300 max-w-2xl">Профессиональный ремонт квартир в монолитном доме под ключ в Москве. Прочные стены, свободная планировка, возможность перепланировки. Цены от 8 000 ₽/м², гарантия 3 года.</p>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h2 class="text-2xl font-bold text-[#111827]" style="font-family:var(--font-heading)">Особенности ремонта в монолитном доме</h2>
                    <p class="mt-4 text-[#4b5563] leading-relaxed">Монолитные дома — это современные дома с каркасом из железобетона. Их главные преимущества: прочные стены, хорошая звукоизоляция, возможность свободной перепланировки. При ремонте можно реализовать любые дизайнерские решения без ограничений.</p>
                    <ul class="mt-4 space-y-2">
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Прочные стены — возможность крепить что угодно</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Свободная планировка — несущие стены только по контуру</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Хорошая звукоизоляция — комфортное проживание</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Возможность перепланировки — реализация любых идей</li>
                    </ul>
                </div>
                <div class="bg-[#f9fafb] rounded-xl p-6">
                    <h3 class="text-lg font-bold text-[#111827]">Цены на ремонт в монолитном доме</h3>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="max-w-lg mx-auto">
                <?php
$ctaFormId = 'monolit_cta';
$ctaFormTitle = 'Рассчитать стоимость ремонта в монолитном доме';
$ctaFormSubtitle = 'Бесплатный расчёт за 5 минут';
$ctaButtonText = 'Рассчитать';
$ctaShowName = true;
$ctaHiddenCity = 'monolit';
$ctaExpandable = false;
...
?>
    ...
    <section class="py-12 bg-[#f9fafb]">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-6 max-w-3xl mx-auto space-y-3">
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Сколько стоит ремонт квартиры в монолитном доме?</summary><p class="mt-2 text-sm text-[#6b7280]">Косметический ремонт от 8 000 ₽/м², капитальный — от 13 000 ₽/м². Монолитные дома обычно newer, поэтому состояние коммуникаций лучше, но стоимость зависит от объёма перепланировки.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Можно ли сделать перепланировку?</summary><p class="mt-2 text-sm text-[#6b7280]">Да, в монолитных домах несущие стены расположены только по периметру квартиры. Внутри можно свободно менять планировку, объединять комнаты, создавать просторные студии.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Какой ремонт лучше для монолитного дома?</summary><p class="mt-2 text-sm text-[#6b7280]">Для монолитных домов идеально подходит дизайнерский ремонт — прочные стены позволяют реализовать любые идеи. Капитальный ремонт также хорош для обновления интерьера.</p></details>
            </div>
        </div>
    </section>
</main>
    <section class="py-12 text-center bg-white">
        ...
        <!-- Финальный CTA -->
        <?php
        $ctaFormId = 'monolit_bottom_cta';
        $ctaFormTitle = 'Рассчитать стоимость ремонта';
        $ctaFormSubtitle = 'Бесплатный расчёт за 5 минут';
        $ctaButtonText = 'Получить расчёт бесплатно';
        $ctaExpandable = false;
        $ctaSectionBadge = 'Бесплатный расчёт';
        $ctaSectionHeading = 'Готовы рассчитать стоимость: ремонт квартир в монолитном доме под ключ';
