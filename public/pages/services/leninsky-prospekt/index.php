...
$seo = Setting\Route\Function\Functions::seo([
    'title' => 'Ремонт квартир на Ленинском проспекте — цены под ключ, гарантия 3 года',
    'description' => 'Ремонт квартир на Ленинском проспекте под ключ. Цены от 8 000 ₽/м². Косметический, капитальный, дизайнерский ремонт. Фиксированная смета, гарантия 3 года.',
    'image' => $site['shareImageUrl'],
    'url' => $site['baseUrl'] . '/services/leninsky-prospekt',
    'type' => 'website',
    'pageType' => 'Service',
    'breadcrumbs' => [
        ['name' => 'Главная', 'url' => $site['baseUrl'] . '/'],
        ['name' => 'Услуги', 'url' => $site['baseUrl'] . '/services/pod-klyuch'],
        ['name' => 'Ремонт квартир на Ленинском проспекте — цены под ключ, гарантия 3 года', 'url' => $site['baseUrl'] . '/services/leninsky-prospekt'],
    ],
    'schema' => [
        Setting\Route\Function\Functions::serviceSchema([
            'slug' => 'leninsky-prospekt',
            'title' => 'Ремонт квартир на Ленинском проспекте — цены под ключ, гарантия 3 года',
            'description' => 'Ремонт квартир на Ленинском проспекте под ключ. Цены от 8 000 ₽/м². Косметический, капитальный, дизайнерский ремонт. Фиксированная смета, гарантия 3 года.',
        ]),
    ],
...
<head>
    ...
    <meta name="keywords" content="Ремонт квартир на Ленинском проспекте — цены под ключ, гарантия 3 года, leninsky-prospekt, ремонт под ключ, ПКвартира, ремонт под ключ, ПКвартира">
    ...
    <main class="pt-20 flex flex-col gap-8 pb-16">
            ...
            <div class="container mx-auto px-4 max-w-4xl">
                <nav aria-label="breadcrumb" class="text-sm text-gray-600 mb-4">
                    <ol class="flex flex-wrap items-center gap-2">
                        ...
                        <li class="text-gray-400">/</li>
                        <li class="text-gray-900 font-medium">Ремонт квартир на Ленинском проспекте — цены под ключ, гарантия 3 года</li>
                    </ol>
                </nav>
                <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Ремонт квартир на Ленинском проспекте — цены под ключ, гарантия 3 года</h1>
                <p class="text-gray-600 text-lg leading-relaxed">
                    Ремонт квартир на Ленинском проспекте под ключ. Цены от 8 000 ₽/м². Косметический, капитальный, дизайнерский ремонт. Фиксированная смета, гарантия 3 года.
                </p>
            </div>
        </section>
        ...
        <section class="container mx-auto px-4 max-w-4xl reveal">
            <div class="bg-white rounded-2xl border border-gray-200 p-6 md:p-8 shadow-sm">
                <h2 class="text-2xl font-bold text-gray-900 mb-4">Что входит в Ремонт квартир на Ленинском проспекте — цены под ключ, гарантия 3 года</h2>
                <p class="text-gray-600 mb-6 leading-relaxed">
                    Полный комплекс работ по ремонт квартир на ленинском проспекте — цены под ключ, гарантия 3 года под ключ. Вы получаете готовый результат без скрытых платежей и с гарантией 3 года.
                </p>
