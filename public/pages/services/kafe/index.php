...
$site = Functions::site();
$title = 'Ремонт кафе под ключ — цены 2026 | Проект Квартира';
...
<head>
    ...
    <meta name="description" content="Ремонт кафе под ключ. Кухня, зал, вентиляция, согласование с СЭС. Цены от 10 000 ₽/м². Гарантия 3 года. От компании Проект Квартира (ПКвартира)."><meta name="robots" content="index, follow">
    <link rel="canonical" href="<?= htmlspecialchars($site['baseUrl'] . '/services/kafe'); ?>">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            {"@type": "BreadcrumbList","itemListElement": [
                ...
                {"@type": "ListItem","position": 2,"name": "Ремонт кафе","item": "<?= $site['baseUrl']; ?>/services/kafe"}
            ]},
            {"@type": "Service","name": "Ремонт кафе под ключ","provider": {"@type": "Organization","name": "Проект Квартира","alternateName": "ПКвартира","brand": "Проект Квартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
...
<main class="pt-20" style="padding-top:80px">
    <section class="relative bg-[#1f2937] text-white">
        ...
        <div class="relative container mx-auto px-4 max-w-6xl py-14 md:py-20">
            <h1 class="text-[28px] md:text-[40px] font-extrabold leading-tight" style="font-family:var(--font-heading)">Ремонт кафе</h1>
            <p class="mt-4 text-[17px] text-gray-300 max-w-2xl">Профессиональный ремонт кафе под ключ. Кухня, зал, вентиляция, согласование с СЭС.</p>
            <div class="mt-6 flex flex-wrap gap-4">
                ...
                <div class="flex items-center gap-2 text-sm text-gray-300"><span class="w-5 h-5 rounded-full bg-orange-500 flex items-center justify-center text-[10px]">✓</span> Согласование с СЭС</div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h2 class="text-2xl font-bold text-[#111827]" style="font-family:var(--font-heading)">Ремонт кафе под ключ в Москве</h2>
                    <p class="mt-4 text-[#4b5563] leading-relaxed">Выполняем ремонт кафе любой площади: от компактных кофеен до больших кафе-ресторанов. Проектируем кухню и зал, монтируем вентиляцию, согласовываем работы с СЭС.</p>
                    <ul class="mt-4 space-y-2">
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Обустройство кухни по нормам СЭС</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Дизайн зала и зонирование</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Система вентиляции и вытяжки</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Согласование с СЭС и Роспотребнадзором</li>
                    </ul>
                </div>
                <div class="bg-[#f9fafb] rounded-xl p-6">
                    <h3 class="text-lg font-bold text-[#111827]">Цены на ремонт кафе</h3>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="max-w-lg mx-auto">
                <?php
$ctaFormId = 'kafe_cta';
$ctaFormTitle = 'Рассчитать стоимость ремонта кафе';
    ...
    <section class="py-12 bg-[#f9fafb]">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-6 max-w-3xl mx-auto space-y-3">
                ...
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Выполняете ли вы монтаж вентиляции для кухни?</summary><p class="mt-2 text-sm text-[#6b7280]">Да, монтируем профессиональные системы вентиляции и вытяжки для кухонь кафе.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Сколько времени занимает ремонт кафе?</summary><p class="mt-2 text-sm text-[#6b7280]">Сроки от 3 недель до 3 месяцев в зависимости от площади и объёма работ.</p></details>
            </div>
        </div>
    </section>
</main>
