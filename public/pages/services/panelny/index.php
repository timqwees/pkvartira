...
$site = Functions::site();
$title = 'Ремонт квартир в панельном доме под ключ — цены 2026 | ПКвартира';
...
<head>
    ...
    <meta name="description" content="Ремонт квартир в панельном доме под ключ в Москве. Тонкие стены, шумоизоляция, замена коммуникаций. Косметический от 8 000 ₽/м², капитальный от 13 000 ₽/м². Гарантия 3 года.">
    <meta name="keywords" content="ремонт в панельном доме, ремонт панельной квартиры, шумоизоляция панельного дома, ремонт панельки цены">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="<?= htmlspecialchars($site['baseUrl'] . '/services/panelny'); ?>">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            {"@type": "BreadcrumbList","itemListElement": [
                ...
                {"@type": "ListItem","position": 2,"name": "Ремонт в панельном доме","item": "<?= $site['baseUrl']; ?>/services/panelny"}
            ]},
            {"@type": "Service","name": "Ремонт квартир в панельном доме","provider": {"@type": "Organization","name": "ПКвартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
...
<main class="pt-20" style="padding-top:80px">
    <section class="relative bg-[#1f2937] text-white">
        ...
        <div class="relative container mx-auto px-4 max-w-6xl py-14 md:py-20">
            <h1 class="text-[28px] md:text-[40px] font-extrabold leading-tight" style="font-family:var(--font-heading)">Ремонт квартир в панельном доме под ключ</h1>
            <p class="mt-4 text-[17px] text-gray-300 max-w-2xl">Профессиональный ремонт квартир в панельном доме под ключ в Москве. Тонкие стены, шумоизоляция, замена коммуникаций. Цены от 8 000 ₽/м², гарантия 3 года.</p>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h2 class="text-2xl font-bold text-[#111827]" style="font-family:var(--font-heading)">Особенности ремонта в панельном доме</h2>
                    <p class="mt-4 text-[#4b5563] leading-relaxed">Панельные дома — самый распространённый тип жилого фонда в Москве. Их главное отличие — тонкие бетонные панели, которые создают проблемы с шумоизоляцией. При ремонте важно усилить звукоизоляцию, заменить коммуникации и грамотно обустроить интерьер.</p>
                    <ul class="mt-4 space-y-2">
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Тонкие стены — обязательная шумоизоляция</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Типовые планировки — оптимизация пространства</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Замена коммуникаций — водоснабжение, электрика, канализация</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Возможность объединения комнат при несущих перегородках</li>
                    </ul>
                </div>
                <div class="bg-[#f9fafb] rounded-xl p-6">
                    <h3 class="text-lg font-bold text-[#111827]">Цены на ремонт в панельном доме</h3>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="max-w-lg mx-auto">
                <?php
$ctaFormId = 'panelny_cta';
$ctaFormTitle = 'Рассчитать стоимость ремонта в панельном доме';
$ctaFormSubtitle = 'Бесплатный расчёт за 5 минут';
$ctaButtonText = 'Рассчитать';
$ctaShowName = true;
$ctaHiddenCity = 'panelny';
$ctaExpandable = false;
...
?>
    ...
    <section class="py-12 bg-[#f9fafb]">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-6 max-w-3xl mx-auto space-y-3">
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Сколько стоит ремонт квартиры в панельном доме?</summary><p class="mt-2 text-sm text-[#6b7280]">Косметический ремонт от 8 000 ₽/м², капитальный — от 13 000 ₽/м². Стоимость зависит от объёма работ по шумоизоляции, замены коммуникаций и отделочных материалов.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Обязательна ли шумоизоляция?</summary><p class="mt-2 text-sm text-[#6b7280]">Да, в панельных домах шумоизоляция значительно повышает уровень комфорта. Мы рекомендуем её при любом типе ремонта, особенно капитальном.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Можно ли заменить коммуникации?</summary><p class="mt-2 text-sm text-[#6b7280]">Да, мы полностью заменяем водоснабжение, электрику и канализацию. Это особенно важно в старых панельных домах, где коммуникации изношены.</p></details>
            </div>
        </div>
    </section>
</main>
    <section class="py-12 text-center bg-white">
        ...
        <!-- Финальный CTA -->
        <?php
        $ctaFormId = 'panelny_bottom_cta';
        $ctaFormTitle = 'Рассчитать стоимость ремонта';
        $ctaFormSubtitle = 'Бесплатный расчёт за 5 минут';
        $ctaButtonText = 'Получить расчёт бесплатно';
        $ctaExpandable = false;
        $ctaSectionBadge = 'Бесплатный расчёт';
        $ctaSectionHeading = 'Готовы рассчитать стоимость: ремонт квартир в панельном доме под ключ';
