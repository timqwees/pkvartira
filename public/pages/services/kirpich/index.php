...
$seo = Setting\Route\Function\Functions::seo([
    'title' => 'Ремонт квартир в кирпичном доме под ключ — цены 2026',
    'description' => 'Ремонт квартир в кирпичном доме под ключ в Москве. Толстые стены, хорошая звукоизоляция, теплоизоляция. Косметический от 8 000 ₽/м², капитальный от 13 000 ₽/м². Гарантия 3 года.',
    'image' => $site['shareImageUrl'],
    'url' => $site['baseUrl'] . '/services/kirpich',
    'type' => 'website',
    'pageType' => 'Service',
    'breadcrumbs' => [
        ['name' => 'Главная', 'url' => $site['baseUrl'] . '/'],
        ['name' => 'Услуги', 'url' => $site['baseUrl'] . '/services/pod-klyuch'],
        ['name' => 'Ремонт квартир в кирпичном доме под ключ — цены 2026', 'url' => $site['baseUrl'] . '/services/kirpich'],
    ],
    'schema' => [
...
<head>
    ...
    <meta name="keywords" content="Ремонт квартир в кирпичном доме под ключ — цены 2026, kirpich, ремонт под ключ, ПКвартира, ремонт под ключ, ПКвартира">
    ...
    <main class="pt-20 flex flex-col gap-8 pb-16">
            ...
            <div class="container mx-auto px-4 max-w-4xl">
                <nav aria-label="breadcrumb" class="text-sm text-gray-600 mb-4">
                    <ol class="flex flex-wrap items-center gap-2">
                        ...
                        <li class="text-gray-400">/</li>
                        <li class="text-gray-900 font-medium">Ремонт квартир в кирпичном доме под ключ — цены 2026</li>
                    </ol>
                </nav>
                <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Ремонт квартир в кирпичном доме под ключ — цены 2026</h1>
                <p class="text-gray-600 text-lg leading-relaxed">
                    Ремонт квартир в кирпичном доме под ключ в Москве. Толстые стены, хорошая звукоизоляция, теплоизоляция. Косметический от 8 000 ₽/м², капитальный от 13 000 ₽/м². Гарантия 3 года.
                </p>
            </div>
        </section>
        ...
        <section class="container mx-auto px-4 max-w-4xl reveal">
            <div class="bg-white rounded-2xl border border-gray-200 p-6 md:p-8 shadow-sm">
                <h2 class="text-2xl font-bold text-gray-900 mb-4">Что входит в Ремонт квартир в кирпичном доме под ключ — цены 2026</h2>
                <p class="text-gray-600 mb-6 leading-relaxed">
                    Полный комплекс работ по ремонт квартир в кирпичном доме под ключ — цены 2026 под ключ. Вы получаете готовый результат без скрытых платежей и с гарантией 3 года.
                </p>
