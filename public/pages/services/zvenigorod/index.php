    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="max-w-lg mx-auto">
                <h2 class="text-2xl font-bold text-[#111827] text-center" style="font-family:var(--font-heading)">Рассчитать стоимость ремонта в Звенигороде</h2>
                <form action="/send/email" method="POST" class="mt-6 space-y-4">
                    ...
                    <input type="hidden" name="Город" value="Звенигород">
