...
<head>
    ...
    <meta name="description" content="Ремонт дома из бревна под ключ в Москве — цены от 10 000 ₽/м². Реставрация, обработка, утепление, отделка. Фиксированная смета, гарантия 3 года.">
    <meta name="keywords" content="ремонт дома из бревна, реставрация бревенчатого дома, отделка сруба, ремонт сруба Москва">
...
<main class="pt-20" style="padding-top:80px">
    <section class="relative bg-[#1f2937] text-white">
        ...
        <div class="relative container mx-auto px-4 max-w-6xl py-14 md:py-20">
            <h1 class="text-[28px] md:text-[40px] font-extrabold leading-tight" style="font-family:var(--font-heading)">Ремонт дома из бревна под ключ</h1>
            <p class="mt-4 text-[17px] text-gray-300 max-w-2xl">Полный цикл ремонта и реставрации дома из бревна в Москве: обработка, утепление, отделка. Фиксированная смета, гарантия 3 года.</p>
            <div class="mt-6 flex flex-wrap gap-4">
                ...
                <div class="flex items-center gap-2 text-sm text-gray-300"><span class="w-5 h-5 rounded-full bg-orange-500 flex items-center justify-center text-[10px]">✓</span> Реставрация</div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h2 class="text-2xl font-bold text-[#111827]" style="font-family:var(--font-heading)">Ремонт дома из бревна под ключ</h2>
                    <p class="mt-4 text-[#4b5563] leading-relaxed">Выполняем ремонт и реставрацию домов из бревна в Москве. Обработка и защита дерева, утепление, вентиляция, внутренняя и наружная отделка. Восстанавливаем и обновляем старые срубы.</p>
                    <ul class="mt-4 space-y-2">
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Реставрация и восстановление брёвен</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Антисептическая и огнезащитная обработка</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Утепление и герметизация швов</li>
                ...
                <div class="bg-[#f9fafb] rounded-xl p-6">
                    <h3 class="text-lg font-bold text-[#111827]">Цены на ремонт дома из бревна</h3>
                    <div class="mt-4 space-y-3">
                        <div class="flex justify-between items-center py-2 border-b border-gray-200"><span class="text-[#4b5563]">Внутренняя отделка</span><span class="font-bold text-[#111827]">от 10 000 ₽/м²</span></div>
                        <div class="flex justify-between items-center py-2"><span class="text-[#4b5563]">Полный цикл</span><span class="font-bold text-[#111827]">от 18 000 ₽/м²</span></div>
                    </div>
                </div>
            </div>
        </div>
...
?>
    ...
    <section class="py-12 bg-[#f9fafb]">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-6 max-w-3xl mx-auto space-y-3">
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Можно ли отреставрировать старый сруб?</summary><p class="mt-2 text-sm text-[#6b7280]">Да, выполняем полную реставрацию: замена повреждённых брёвен, конопатка швов, обработка дерева, обновление отделки.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Как защитить дерево от насекомых и гниения?</summary><p class="mt-2 text-sm text-[#6b7280]">Используем антисептики глубокого проникновения. Обработка проводится каждые 3-5 лет для поддержания защиты.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Сколько стоит ремонт дома из бревна?</summary><p class="mt-2 text-sm text-[#6b7280]">Цены от 10 000 ₽/м². Реставрация старых срубов может стоить дороже. Рассчитаем смету после бесплатного замера.</p></details>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 text-center bg-white">
        ...
        <!-- Финальный CTA -->
        <?php
        $ctaFormId = 'iz-breven_bottom_cta';
        $ctaFormTitle = 'Рассчитать стоимость ремонта';
        $ctaFormSubtitle = 'Бесплатный расчёт за 5 минут';
        $ctaButtonText = 'Получить расчёт бесплатно';
        $ctaExpandable = false;
        $ctaSectionBadge = 'Бесплатный расчёт';
        $ctaSectionHeading = 'Готовы рассчитать стоимость: ремонт дома из бревна под ключ';
