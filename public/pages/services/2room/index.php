...
$prices = [
    [
        ...
        'цена' => 'от 8 000 ₽',
        'цена_число' => '8000',
        'подзаголовок' => 'Итого для 50 м² - от 400 000 Р',
    ...
    [
        ...
        'цена' => 'от 13 000 ₽',
        'цена_число' => '13000',
        'подзаголовок' => 'Итого для 50 м² - от 650 000 Р',
    ...
    [
        ...
        'цена' => 'от 18 000 ₽',
        'цена_число' => '18000',
        'подзаголовок' => 'Итого для 50 м² - от 900 000 Р',
...
$portfolio = array_merge(
    (new Functions())->getPortfolio('public/assets/images/portfolio-photos/2room/standard'),
    (new Functions())->getPortfolio('public/assets/images/portfolio-photos/2room/standard')
);
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="canonical" href="<?= htmlspecialchars($site['baseUrl'] . '/services/2room'); ?>">
    ...
    "@graph": [
      ...
      },
      {
        ...
        "@id": <?= json_encode($site['canonicalUrl'] . '#service', JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE); ?>,
                    "name": "Отделка двухкомнатных квартир под ключ",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            "@type": "ListItem",
            "position": 3,
                    "name": "Отделка двухкомнатной квартиры",
                    ...
                    <div class="relative">
                        <form action="<?= htmlspecialchars($site['baseUrl']); ?>/send/email" method="POST"
                            ...
                            <div
                                ...
                                <h2 class="text-lg md:text-xl font-bold text-gray-900">Рассчитайте бюджет
                                    ремонта
                                </h2>
                ...
                <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <?php foreach ($prices as $price): ?>
                        <article
                            ...
                            <meta itemprop="name"
                                content="<?= htmlspecialchars($price['заголовок']); ?> для двухкомнатной квартиры">
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="relative grid md:grid-cols-3 lg:grid-cols-6 gap-6">
                    ...
                    <div class="text-center z-10">
                        ...
                        <p class="text-sm text-gray-600">
                            Подписываем договор, где прописаны сроки и финальная сумма. Цена
                    ...
                    <?php foreach ($portfolio as $key => $value): ?>
                        <article class="border border-gray-200 rounded-2xl overflow-hidden bg-white shadow-sm" itemscope
                            ...
                            <meta itemprop="description"
                                content="Двушка, срок: <?= htmlspecialchars($value['срок']); ?>, бюджет: <?= htmlspecialchars($value['цена']); ?>">
        ...
        <section class="w-full py-12 md:py-16 bg-gray-50">
            <div
                ...
                <p class="text-blue-100 mb-8">
                    Мы подготовим смету — оставьте заявку на бесплатный расчёт.
                </p>
