    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="max-w-lg mx-auto">
                <?php
$ctaFormId = 'ontario_cta';
$ctaFormTitle = 'Рассчитайте стоимость ремонта в ЖК Онтарио';
