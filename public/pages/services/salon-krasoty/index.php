...
$site = Functions::site();
$title = 'Ремонт салона красоты под ключ — цены 2026 | Проект Квартира';
...
<head>
    ...
    <meta name="description" content="Ремонт салона красоты под ключ. Зонирование, освещение, вентиляция для красок. Цены от 8 000 ₽/м². Гарантия 3 года. От компании Проект Квартира (ПКвартира)."><meta name="robots" content="index, follow">
    <link rel="canonical" href="<?= htmlspecialchars($site['baseUrl'] . '/services/salon-krasoty'); ?>">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            {"@type": "BreadcrumbList","itemListElement": [
                ...
                {"@type": "ListItem","position": 2,"name": "Ремонт салона красоты","item": "<?= $site['baseUrl']; ?>/services/salon-krasoty"}
            ]},
            {"@type": "Service","name": "Ремонт салона красоты под ключ","provider": {"@type": "Organization","name": "Проект Квартира","alternateName": "ПКвартира","brand": "Проект Квартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
...
<main class="pt-20" style="padding-top:80px">
    <section class="relative bg-[#1f2937] text-white">
        ...
        <div class="relative container mx-auto px-4 max-w-6xl py-14 md:py-20">
            <h1 class="text-[28px] md:text-[40px] font-extrabold leading-tight" style="font-family:var(--font-heading)">Ремонт салона красоты</h1>
            <p class="mt-4 text-[17px] text-gray-300 max-w-2xl">Профессиональный ремонт салонов красоты под ключ. Зонирование, освещение, вентиляция для химических красок.</p>
            <div class="mt-6 flex flex-wrap gap-4">
                ...
                <div class="flex items-center gap-2 text-sm text-gray-300"><span class="w-5 h-5 rounded-full bg-orange-500 flex items-center justify-center text-[10px]">✓</span> Вентиляция для красок</div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h2 class="text-2xl font-bold text-[#111827]" style="font-family:var(--font-heading)">Ремонт салона красоты под ключ</h2>
                    <p class="mt-4 text-[#4b5563] leading-relaxed">Создаём уютные и функциональные салоны красоты. Проектируем зонирование, монтируем профессиональное освещение и системы вентиляции для безопасной работы с химическими красками.</p>
                    <ul class="mt-4 space-y-2">
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Зонирование: зал, маникюр, педикюр, СПА</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Профессиональное освещение</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Вентиляция для химических красок</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Водоснабжение и канализация</li>
                    </ul>
                </div>
                <div class="bg-[#f9fafb] rounded-xl p-6">
                    <h3 class="text-lg font-bold text-[#111827]">Цены на ремонт салона красоты</h3>
                    <div class="mt-4 space-y-3">
                        <div class="flex justify-between items-center py-2 border-b border-gray-200"><span class="text-[#4b5563]">Стандарт</span><span class="font-bold text-[#111827]">от 8 000 ₽/м²</span></div>
                        <div class="flex justify-between items-center py-2"><span class="text-[#4b5563]">Премиум</span><span class="font-bold text-[#111827]">от 15 000 ₽/м²</span></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="max-w-lg mx-auto">
                <?php
$ctaFormId = 'salon-krasoty_cta';
$ctaFormTitle = 'Рассчитать стоимость ремонта салона красоты';
    ...
    <section class="py-12 bg-[#f9fafb]">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-6 max-w-3xl mx-auto space-y-3">
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Помогаете ли вы с проектированием зонирования?</summary><p class="mt-2 text-sm text-[#6b7280]">Да,我们的设计师 разработают проект зонирования с учётом ваших пожеланий и технологических требований.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Выполняете ли вы монтаж вентиляции для красок?</summary><p class="mt-2 text-sm text-[#6b7280]">Да, монтируем профессиональные системы вентиляции для безопасной работы с химическими красками.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Сколько времени занимает ремонт салона красоты?</summary><p class="mt-2 text-sm text-[#6b7280]">Сроки от 2 недель до 2 месяцев в зависимости от площади и сложности проекта.</p></details>
            </div>
        </div>
    </section>
</main>
    <section class="py-12 text-center bg-white">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-4 flex flex-wrap justify-center gap-3">
                ...
                <a href="/services/office" class="px-4 py-2 rounded-lg bg-white border border-gray-200 text-sm text-[#4b5563] hover:border-orange-500">Офис</a>
