...
$site = Functions::site();
$title = 'Ремонт квартиры для жизни — цены 2026 | Проект Квартира';
...
<head>
    ...
    <meta name="description" content="Ремонт квартиры для жизни в Москве — цены от 13 000 ₽/м². Комфортное пространство для семьи, качественные материалы. Фиксированная смета, гарантия 3 года. От компании Проект Квартира (ПКвартира)."><meta name="robots" content="index, follow">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            ...
            {"@type": "Service","name": "Ремонт квартиры для жизни","provider": {"@type": "Organization","name": "Проект Квартира","alternateName": "ПКвартира","brand": "Проект Квартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
