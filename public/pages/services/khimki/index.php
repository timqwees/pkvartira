...
$site = Functions::site();
$title = 'Ремонт квартир в Химках — цены под ключ, гарантия 3 года | ПКвартира';
...
<head>
    ...
    <meta name="description" content="Ремонт квартир в Химках под ключ. Цены от 8 000 ₽/м². Косметический, капитальный, дизайнерский ремонт. Фиксированная смета, гарантия 3 года. Смета и замер в Химках бесплатно.">
    <meta name="keywords" content="ремонт квартир Химки, ремонт под ключ в Химках, отделка квартир в Химках, ремонт квартир в Химки цены">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            ...
            {"@type": "Service","name": "Ремонт квартир в Химках","provider": {"@type": "Organization","name": "ПКвартира"},"areaServed": {"@type": "City","name": "Химки"}}
        ]
    }
    </script>
</head>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="max-w-lg mx-auto">
                <h2 class="text-2xl font-bold text-[#111827] text-center" style="font-family:var(--font-heading)">Рассчитать стоимость ремонта в Химках</h2>
                <form action="/send/email" method="POST" class="mt-6 space-y-4">
                    ...
                    <input type="hidden" name="Город" value="Химки">
