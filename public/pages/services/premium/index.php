...
<head>
    ...
    <meta name="description" content="<?= htmlspecialchars(\Setting\Route\Function\Functions::truncateSeo('Премиальный ремонт квартир в Москве — цены от 18 000 ₽/м². Элитные материалы, авторский дизайн, меблировка, «умный дом». Фиксированная смета, гарантия 3 года.',155)); ?>"><meta name="robots" content="index, follow">
