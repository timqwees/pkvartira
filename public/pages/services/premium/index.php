...
$site = Functions::site();
$title = 'Премиальный ремонт квартир в Москве — цены 2026 | ПКвартира';
...
<head>
    ...
    <meta name="description" content="Премиальный ремонт квартир в Москве — цены от 18 000 ₽/м². Элитные материалы, авторский дизайн, меблировка, «умный дом». Фиксированная смета, гарантия 3 года.">
    <meta name="keywords" content="премиальный ремонт квартир, элитный ремонт, люксовый ремонт, ремонт премиум класса Москва">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            ...
            {"@type": "Service","name": "Премиальный ремонт квартир","provider": {"@type": "Organization","name": "ПКвартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
