...
$site = Functions::site();
$title = 'Ремонт каркасного дома под ключ — цены 2026 | ПКвартира';
...
<head>
    ...
    <meta name="description" content="Ремонт каркасного дома под ключ в Москве — цены от 8 000 ₽/м². Утепление, вентиляция, отделка, инженерные системы. Фиксированная смета, гарантия 3 года.">
    <meta name="keywords" content="ремонт каркасного дома, отделка каркасного дома, утепление каркасного дома, ремонт каркасника Москва">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            {"@type": "BreadcrumbList","itemListElement": [
                ...
                {"@type": "ListItem","position": 2,"name": "Ремонт каркасного дома","item": "<?= $site['baseUrl']; ?>/services/karkasny"}
            ]},
            {"@type": "Service","name": "Ремонт каркасного дома","provider": {"@type": "Organization","name": "ПКвартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
...
<main class="pt-20" style="padding-top:80px">
    <section class="relative bg-[#1f2937] text-white">
        ...
        <div class="relative container mx-auto px-4 max-w-6xl py-14 md:py-20">
            <h1 class="text-[28px] md:text-[40px] font-extrabold leading-tight" style="font-family:var(--font-heading)">Ремонт каркасного дома под ключ</h1>
            <p class="mt-4 text-[17px] text-gray-300 max-w-2xl">Полный цикл ремонта каркасного дома в Москве: утепление, вентиляция, отделка, инженерные системы. Фиксированная смета, гарантия 3 года.</p>
            <div class="mt-6 flex flex-wrap gap-4">
                ...
                <div class="flex items-center gap-2 text-sm text-gray-300"><span class="w-5 h-5 rounded-full bg-orange-500 flex items-center justify-center text-[10px]">✓</span> Полный цикл</div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h2 class="text-2xl font-bold text-[#111827]" style="font-family:var(--font-heading)">Ремонт каркасного дома под ключ</h2>
                    <p class="mt-4 text-[#4b5563] leading-relaxed">Выполняем ремонт каркасных домов в Москве под ключ. Утепление стен и кровли, монтаж вентиляции, внутренняя и наружная отделка, инженерные системы. Учитываем особенности каркасной конструкции.</p>
                    <ul class="mt-4 space-y-2">
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Утепление стен, кровли и пола</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Монтаж вентиляции и климат-систем</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Внутренняя и наружная отделка</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Инженерные системы: электрика, водоснабжение, отопление</li>
                    </ul>
                </div>
                <div class="bg-[#f9fafb] rounded-xl p-6">
                    <h3 class="text-lg font-bold text-[#111827]">Цены на ремонт каркасного дома</h3>
                    <div class="mt-4 space-y-3">
                        <div class="flex justify-between items-center py-2 border-b border-gray-200"><span class="text-[#4b5563]">Внутренняя отделка</span><span class="font-bold text-[#111827]">от 8 000 ₽/м²</span></div>
                        <div class="flex justify-between items-center py-2"><span class="text-[#4b5563]">Полный цикл</span><span class="font-bold text-[#111827]">от 15 000 ₽/м²</span></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-12 bg-[#f9fafb]">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-6 max-w-3xl mx-auto space-y-3">
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Нужно ли утеплять каркасный дом?</summary><p class="mt-2 text-sm text-[#6b7280]">Да, утепление — обязательный этап. Без него дом будет холодным и некомфортным. Используем минеральную вату и пенополистирол.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Сколько времени занимает ремонт каркасного дома?</summary><p class="mt-2 text-sm text-[#6b7280]">Сроки зависят от площади и объёма работ. Внутренняя отделка — от 3 недель, полный цикл — от 2 месяцев.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Какие инженерные системы устанавливаете?</summary><p class="mt-2 text-sm text-[#6b7280]">Электрика, водоснабжение, канализация, отопление, вентиляция, кондиционирование. Полный спектр инженерных систем.</p></details>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 text-center bg-white">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-4 flex flex-wrap justify-center gap-3">
                ...
                <a href="/services/iz-breven" class="px-4 py-2 rounded-lg bg-white border border-gray-200 text-sm text-[#4b5563] hover:border-orange-500">Дом из бревна</a>
        ...
        <!-- Финальный CTA -->
        <?php
        $ctaFormId = 'karkasny_bottom_cta';
        $ctaFormTitle = 'Рассчитать стоимость ремонта';
        $ctaFormSubtitle = 'Бесплатный расчёт за 5 минут';
        $ctaButtonText = 'Получить расчёт бесплатно';
        $ctaExpandable = false;
        $ctaSectionBadge = 'Бесплатный расчёт';
        $ctaSectionHeading = 'Готовы рассчитать стоимость: ремонт каркасного дома под ключ';
