...
$seo = Setting\Route\Function\Functions::seo([
    'title' => 'Укладка ламината в Москве — цена за м² с работой и фанерой',
    'description' => 'Укладка ламината в Москве — цена за квадратный метр вместе с укладкой фанеры. Стоимость работы от 350 ₽/м², с материалом от 800 ₽/м². Гарантия 3 года, выезд мастера бесплатно.',
    'image' => $site['shareImageUrl'],
    'url' => $site['baseUrl'] . '/services/ukladka-laminata',
    'type' => 'website',
    'pageType' => 'Service',
    'breadcrumbs' => [
        ['name' => 'Главная', 'url' => $site['baseUrl'] . '/'],
        ['name' => 'Услуги', 'url' => $site['baseUrl'] . '/services/pod-klyuch'],
        ['name' => 'Укладка ламината в Москве — цена за м² с работой и фанерой', 'url' => $site['baseUrl'] . '/services/ukladka-laminata'],
    ],
    'schema' => [
...
<head>
    ...
    <meta name="keywords" content="Укладка ламината в Москве — цена за м² с работой и фанерой, ukladka-laminata, ремонт под ключ, ПКвартира, ремонт под ключ, ПКвартира">
    ...
    <main class="pt-20 flex flex-col gap-8 pb-16">
            ...
            <div class="container mx-auto px-4 max-w-4xl">
                <nav aria-label="breadcrumb" class="text-sm text-gray-600 mb-4">
                    <ol class="flex flex-wrap items-center gap-2">
                        ...
                        <li class="text-gray-400">/</li>
                        <li class="text-gray-900 font-medium">Укладка ламината в Москве — цена за м² с работой и фанерой</li>
                    </ol>
                </nav>
                <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Укладка ламината в Москве — цена за м² с работой и фанерой</h1>
                <p class="text-gray-600 text-lg leading-relaxed">
                    Укладка ламината в Москве — цена за квадратный метр вместе с укладкой фанеры. Стоимость работы от 350 ₽/м², с материалом от 800 ₽/м². Гарантия 3 года, выезд мастера бесплатно.
                </p>
            </div>
        </section>
        ...
        <section class="container mx-auto px-4 max-w-4xl reveal">
            <div class="bg-white rounded-2xl border border-gray-200 p-6 md:p-8 shadow-sm">
                <h2 class="text-2xl font-bold text-gray-900 mb-4">Что входит в Укладка ламината в Москве — цена за м² с работой и фанерой</h2>
                <p class="text-gray-600 mb-6 leading-relaxed">
                    Полный комплекс работ по укладка ламината в москве — цена за м² с работой и фанерой под ключ. Вы получаете готовый результат без скрытых платежей и с гарантией 3 года.
                </p>
