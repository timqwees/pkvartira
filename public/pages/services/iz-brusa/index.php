...
$site = Functions::site();
$title = 'Ремонт дома из бруса под ключ — цены 2026 | Проект Квартира';
...
<head>
    ...
    <meta name="description" content="Ремонт дома из бруса под ключ в Москве — цены от 8 000 ₽/м². Обработка дерева, утепление, вентиляция, отделка. Фиксированная смета, гарантия 3 года. От компании Проект Квартира (ПКвартира)."><meta name="robots" content="index, follow">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            {"@type": "BreadcrumbList","itemListElement": [
                ...
                {"@type": "ListItem","position": 2,"name": "Ремонт дома из бруса","item": "<?= $site['baseUrl']; ?>/services/iz-brusa"}
            ]},
            {"@type": "Service","name": "Ремонт дома из бруса","provider": {"@type": "Organization","name": "Проект Квартира","alternateName": "ПКвартира","brand": "Проект Квартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
...
<main class="pt-20" style="padding-top:80px">
    <section class="relative bg-[#1f2937] text-white">
        ...
        <div class="relative container mx-auto px-4 max-w-6xl py-14 md:py-20">
            <h1 class="text-[28px] md:text-[40px] font-extrabold leading-tight" style="font-family:var(--font-heading)">Ремонт дома из бруса под ключ</h1>
            <p class="mt-4 text-[17px] text-gray-300 max-w-2xl">Полный цикл ремонта дома из бруса в Москве: обработка дерева, утепление, вентиляция, отделка. Фиксированная смета, гарантия 3 года.</p>
            <div class="mt-6 flex flex-wrap gap-4">
                ...
                <div class="flex items-center gap-2 text-sm text-gray-300"><span class="w-5 h-5 rounded-full bg-orange-500 flex items-center justify-center text-[10px]">✓</span> Обработка дерева</div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h2 class="text-2xl font-bold text-[#111827]" style="font-family:var(--font-heading)">Ремонт дома из бруса под ключ</h2>
                    <p class="mt-4 text-[#4b5563] leading-relaxed">Выполняем ремонт домов из бруса в Москве под ключ. Антисептическая обработка, утепление, вентиляция, внутренняя и наружная отделка. Учитываем особенности деревянных конструкций.</p>
                    <ul class="mt-4 space-y-2">
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Антисептическая и огнезащитная обработка дерева</li>
                ...
                <div class="bg-[#f9fafb] rounded-xl p-6">
                    <h3 class="text-lg font-bold text-[#111827]">Цены на ремонт дома из бруса</h3>
...
?>
    ...
    <section class="py-12 bg-[#f9fafb]">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-6 max-w-3xl mx-auto space-y-3">
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Нужна ли обработка дерева?</summary><p class="mt-2 text-sm text-[#6b7280]">Да, антисептическая обработка обязательна. Она защищает дерево от гниения, насекомых и возгорания. Рекомендуем обновлять каждые 3-5 лет.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Какое утепление лучше для брусового дома?</summary><p class="mt-2 text-sm text-[#6b7280]">Используем минеральную вату или экструдированный пенополистирол. Выбор зависит от конструкции стен и климатических условий.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Сколько стоит ремонт дома из бруса?</summary><p class="mt-2 text-sm text-[#6b7280]">Цены от 8 000 ₽/м². Точная стоимость зависит от объёма работ. Рассчитаем смету после бесплатного замера.</p></details>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 text-center bg-white">
        ...
        <!-- Финальный CTA -->
        <?php
        $ctaFormId = 'iz-brusa_bottom_cta';
        $ctaFormTitle = 'Рассчитать стоимость ремонта';
        $ctaFormSubtitle = 'Бесплатный расчёт за 5 минут';
        $ctaButtonText = 'Получить расчёт бесплатно';
        $ctaExpandable = false;
        $ctaSectionBadge = 'Бесплатный расчёт';
        $ctaSectionHeading = 'Готовы рассчитать стоимость: ремонт дома из бруса под ключ';
