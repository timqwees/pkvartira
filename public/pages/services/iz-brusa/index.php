...
$site = Functions::site();
$title = 'Ремонт дома из бруса под ключ — цены 2026 | ПКвартира';
...
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            ...
            {"@type": "Service","name": "Ремонт дома из бруса","provider": {"@type": "Organization","name": "ПКвартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
