...
$site = Functions::site();
$title = 'Ремонт офиса под ключ — цены в Москве 2026 | Проект Квартира';
...
<head>
    ...
    <meta name="description" content="Ремонт офиса под ключ в Москве. Цены от 5 000 ₽/м². Переговорные, open space, серверная. Согласование с БЦ, работа в нерабочее время. Гарантия 3 года. От компании Проект Квартира (ПКвартира)."><meta name="robots" content="index, follow">
    <link rel="canonical" href="<?= htmlspecialchars($site['baseUrl'] . '/services/office'); ?>">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            {"@type": "BreadcrumbList","itemListElement": [
                ...
                {"@type": "ListItem","position": 2,"name": "Ремонт офиса","item": "<?= $site['baseUrl']; ?>/services/office"}
            ]},
            {"@type": "Service","name": "Ремонт офиса под ключ","provider": {"@type": "Organization","name": "Проект Квартира","alternateName": "ПКвартира","brand": "Проект Квартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
...
<main class="pt-20" style="padding-top:80px">
    <section class="relative bg-[#1f2937] text-white">
        ...
        <div class="relative container mx-auto px-4 max-w-6xl py-14 md:py-20">
            <h1 class="text-[28px] md:text-[40px] font-extrabold leading-tight" style="font-family:var(--font-heading)">Ремонт офиса под ключ</h1>
            <p class="mt-4 text-[17px] text-gray-300 max-w-2xl">Профессиональный ремонт офисных помещений в Москве. Переговорные, open space, серверные. Согласование с бизнес-центрами, работа в нерабочее время.</p>
            <div class="mt-6 flex flex-wrap gap-4">
                ...
                <div class="flex items-center gap-2 text-sm text-gray-300"><span class="w-5 h-5 rounded-full bg-orange-500 flex items-center justify-center text-[10px]">✓</span> Работа в нерабочее время</div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h2 class="text-2xl font-bold text-[#111827]" style="font-family:var(--font-heading)">Ремонт офиса под ключ в Москве</h2>
                    <p class="mt-4 text-[#4b5563] leading-relaxed">Выполняем ремонт офисных помещений любой сложности: переговорные, зоны open space, серверные, рецепции. Согласовываем работы с администрацией бизнес-центров. Работаем в нерабочее время, чтобы не нарушать рабочий процесс.</p>
                    <ul class="mt-4 space-y-2">
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Монтаж перегородок и зонирование</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Проектирование и ремонт серверных</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Согласование с бизнес-центрами</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Работа в выходные и ночное время</li>
                    </ul>
                </div>
                <div class="bg-[#f9fafb] rounded-xl p-6">
                    <h3 class="text-lg font-bold text-[#111827]">Цены на ремонт офиса</h3>
                    <div class="mt-4 space-y-3">
                        ...
                        <div class="flex justify-between items-center py-2 border-b border-gray-200"><span class="text-[#4b5563]">Капитальный</span><span class="font-bold text-[#111827]">от 10 000 ₽/м²</span></div>
                        <div class="flex justify-between items-center py-2"><span class="text-[#4b5563]">Дизайнерский</span><span class="font-bold text-[#111827]">от 15 000 ₽/м²</span></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="max-w-lg mx-auto">
                <?php
$ctaFormId = 'office_cta';
$ctaFormTitle = 'Рассчитать стоимость ремонта офиса';
    ...
    <section class="py-12 bg-[#f9fafb]">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-6 max-w-3xl mx-auto space-y-3">
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Можете ли вы выполнять работы в нерабочее время?</summary><p class="mt-2 text-sm text-[#6b7280]">Да, мы работаем в ночное время и выходные, чтобы не нарушать рабочий процесс в вашем офисе.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Помогаете ли вы с согласованием работ с бизнес-центром?</summary><p class="mt-2 text-sm text-[#6b7280]">Да, мы берём на себя согласование всех работ с администрацией бизнес-центра.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Сколько времени занимает ремонт офиса?</summary><p class="mt-2 text-sm text-[#6b7280]">Сроки зависят от объёма работ. Косметический ремонт — от 5 дней, капитальный — от 2 недель.</p></details>
            </div>
        </div>
    </section>
</main>
    <section class="py-12 text-center bg-white">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-4 flex flex-wrap justify-center gap-3">
                ...
                <a href="/services/showroom" class="px-4 py-2 rounded-lg bg-white border border-gray-200 text-sm text-[#4b5563] hover:border-orange-500">Шоу-рум</a>
                <a href="/services/salon-krasoty" class="px-4 py-2 rounded-lg bg-white border border-gray-200 text-sm text-[#4b5563] hover:border-orange-500">Салон красоты</a>
                <a href="/services/kafe" class="px-4 py-2 rounded-lg bg-white border border-gray-200 text-sm text-[#4b5563] hover:border-orange-500">Кафе</a>
                <a href="/services/restoran" class="px-4 py-2 rounded-lg bg-white border border-gray-200 text-sm text-[#4b5563] hover:border-orange-500">Ресторан</a>
