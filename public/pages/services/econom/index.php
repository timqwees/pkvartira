...
<head>
    ...
    <meta name="description" content="<?= htmlspecialchars(\Setting\Route\Function\Functions::truncateSeo('Ремонт квартиры эконом класса в Москве — цены от 5 000 ₽/м². Качественная отделка по доступной цене, надёжные материалы. Фиксированная смета, гарантия 3 года. — Проект Квартира (ПКвартира).',155)); ?>"><meta name="robots" content="index, follow">
