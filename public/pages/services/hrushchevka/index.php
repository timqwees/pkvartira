...
$title = 'Ремонт квартир в хрущёвке под ключ — цены в Москве 2026 | Проект Квартира';
...
<head>
    ...
    <meta name="description" content="<?= htmlspecialchars(\Setting\Route\Functions\TheFunction::truncateSeo('Ремонт квартир в хрущёвке под ключ в Москве. Косметический от 8 000 ₽/м², капитальный от 13 000 ₽/м². Учитываем особенности панельных стен, низкие потолки. Гарантия 3 года. — Проект Квартира (ПКвартира).',155)); ?>"><meta name="robots" content="index, follow">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            {"@type": "BreadcrumbList","itemListElement": [
                ...
                {"@type": "ListItem","position": 2,"name": "Ремонт в хрущёвке","item": "<?= $site['baseUrl']; ?>/services/hrushchevka"}
            ]},
            {"@type": "Service","name": "Ремонт квартир в хрущёвке","provider": {"@type": "Organization","name": "Проект Квартира","alternateName": "ПКвартира","brand": "Проект Квартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
...
<main class="pt-20" style="padding-top:80px">
    <section class="relative bg-[#1f2937] text-white">
        ...
        <div class="relative container mx-auto px-4 max-w-6xl py-14 md:py-20">
            <h1 class="text-[28px] md:text-[40px] font-extrabold leading-tight" style="font-family:var(--font-heading)">Ремонт квартир в хрущёвке под ключ</h1>
            <p class="mt-4 text-[17px] text-gray-300 max-w-2xl">Профессиональный ремонт квартир в хрущёвке под ключ в Москве. Цены от 8 000 ₽/м². Фиксированная смета, гарантия 3 года, бесплатный замер.</p>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h2 class="text-2xl font-bold text-[#111827]" style="font-family:var(--font-heading)">Особенности ремонта в хрущёвке</h2>
                    <p class="mt-4 text-[#4b5563] leading-relaxed">Хрущёвки — это типовые панельные и кирпичные дома 50–80х годов. Их главные особенности: тонкие стены, низкие потолки около 2,5 м, маленькие кухни и типовые планировки. При ремонте важно учитывать эти особенности, чтобы получить комфортное пространство.</p>
                    <ul class="mt-4 space-y-2">
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Тонкие стены — требуется шумоизоляция</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Низкие потолки — правильный выбор отделки</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Маленькие кухни — функциональные решения</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Возможность перепланировки для увеличения пространства</li>
                    </ul>
                </div>
                <div class="bg-[#f9fafb] rounded-xl p-6">
                    <h3 class="text-lg font-bold text-[#111827]">Цены на ремонт в хрущёвке</h3>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="max-w-lg mx-auto">
                <?php
$ctaFormId = 'hrushchevka_cta';
$ctaFormTitle = 'Рассчитать стоимость ремонта в хрущёвке';
$ctaFormSubtitle = 'Бесплатный расчёт за 5 минут';
$ctaButtonText = 'Рассчитать';
$ctaShowName = true;
$ctaHiddenCity = 'hrushchevka';
$ctaExpandable = false;
    ...
    <section class="py-12 bg-[#f9fafb]">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-6 max-w-3xl mx-auto space-y-3">
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Сколько стоит ремонт квартиры в хрущёвке?</summary><p class="mt-2 text-sm text-[#6b7280]">Косметический ремонт от 8 000 ₽/м², капитальный — от 13 000 ₽/м². Точная стоимость зависит от объёма работ и материалов. Рассчитаем смету после бесплатного замера.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Можно ли сделать перепланировку в хрущёвке?</summary><p class="mt-2 text-sm text-[#6b7280]">Да, большинство несущих стен в хрущёвках можно сносить или перемещать. Мы подберём оптимальную планировку под ваш бюджет.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Какой ремонт лучше — капитальный или дизайнерский?</summary><p class="mt-2 text-sm text-[#6b7280]">Для хрущёвок рекомендуем капитальный или дизайнерский ремонт, так как он позволяет полностью обновить инженерные сети и увеличить полезное пространство.</p></details>
            </div>
        </div>
    </section>
</main>
