...
$site = Functions::site();
$title = 'Ремонт квартир под ключ в Москве — от 15 000 ₽/м²';
...
<head>
    ...
    <title>Ремонт квартир под ключ в Москве — от 15 000 ₽/м² | ПКвартира</title>
    <meta name="description"
        content="Ремонт квартир под ключ в Москве от 15 000 ₽/м². Полный цикл: от дизайн-проекта до финальной уборки. Без скрытых платежей, сроки в договоре, гарантия 3 года. Замер бесплатно.">
    <meta name="keywords"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    <div>
                        ...
                        <p class="mt-4 max-w-xl">
                            Один подрядчик на все этапы: от замера до финальной уборки. Вам не нужно координировать бригады, искать материалы или проверять сроки — мы берём всё на себя. Приедем, замерим, составим смету и сделаем ремонт под ключ строго по договору.
                        </p>
