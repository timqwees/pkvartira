...
$seo = Setting\Route\Function\Functions::seo([
    'title' => 'Смета на ремонт квартиры — рассчитать онлайн бесплатно',
    'description' => 'Смета на ремонт квартиры — рассчитать онлайн бесплатно. Точный расчёт за 30 минут, бесплатный выезд инженера. Калькулятор ремонта онлайн.',
    'image' => $site['shareImageUrl'],
    'url' => $site['baseUrl'] . '/services/smeta',
    'type' => 'website',
    'pageType' => 'Service',
    'breadcrumbs' => [
        ['name' => 'Главная', 'url' => $site['baseUrl'] . '/'],
        ['name' => 'Услуги', 'url' => $site['baseUrl'] . '/services/pod-klyuch'],
        ['name' => 'Смета на ремонт квартиры — рассчитать онлайн бесплатно', 'url' => $site['baseUrl'] . '/services/smeta'],
    ],
    'schema' => [
...
<head>
    ...
    <meta name="keywords" content="Смета на ремонт квартиры — рассчитать онлайн бесплатно, smeta, ремонт под ключ, ПКвартира, ремонт под ключ, ПКвартира">
    ...
    <main class="pt-20 flex flex-col gap-8 pb-16">
            ...
            <div class="container mx-auto px-4 max-w-4xl">
                <nav aria-label="breadcrumb" class="text-sm text-gray-600 mb-4">
                    <ol class="flex flex-wrap items-center gap-2">
                        ...
                        <li class="text-gray-400">/</li>
                        <li class="text-gray-900 font-medium">Смета на ремонт квартиры — рассчитать онлайн бесплатно</li>
                    </ol>
                </nav>
                <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Смета на ремонт квартиры — рассчитать онлайн бесплатно</h1>
                <p class="text-gray-600 text-lg leading-relaxed">
                    Смета на ремонт квартиры — рассчитать онлайн бесплатно. Точный расчёт за 30 минут, бесплатный выезд инженера. Калькулятор ремонта онлайн.
                </p>
            </div>
        </section>
        ...
        <section class="container mx-auto px-4 max-w-4xl reveal">
            <div class="bg-white rounded-2xl border border-gray-200 p-6 md:p-8 shadow-sm">
                <h2 class="text-2xl font-bold text-gray-900 mb-4">Что входит в Смета на ремонт квартиры — рассчитать онлайн бесплатно</h2>
                <p class="text-gray-600 mb-6 leading-relaxed">
                    Полный комплекс работ по смета на ремонт квартиры — рассчитать онлайн бесплатно под ключ. Вы получаете готовый результат без скрытых платежей и с гарантией 3 года.
                </p>
