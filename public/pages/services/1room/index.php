...
$prices = [
    [
        ...
        'цена' => 'от 8 000 ₽',
        'цена_число' => '8000',
        'подзаголовок' => 'Итого для 37 м² - от 296 000 Р',
    ...
    [
        ...
        'цена' => 'от 13 000 ₽',
        'цена_число' => '13000',
        'подзаголовок' => 'Итого для 37 м² - от 520 000 Р',
    ...
    [
        ...
        'цена' => 'от 18 000 ₽',
        'цена_число' => '18000',
        'подзаголовок' => 'Итого для 37 м² - от 720 000 Р',
...
$portfolio = array_merge(
    (new Functions())->getPortfolio('public/assets/images/portfolio-photos/1room/standard'),
    (new Functions())->getPortfolio('public/assets/images/portfolio-photos/1room/standard')
);
?>
<!DOCTYPE html>
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": "Ремонт 1-комнатной квартиры",
...
<body class="bg-white">
    ...
    <main class="pt-20 flex flex-col gap-0">
                ...
                <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <?php foreach ($prices as $price): ?>
                        <article
                            ...
                            <meta itemprop="name"
                                content="<?= htmlspecialchars($price['заголовок']); ?> ремонт однокомнатной квартиры">
        ...
        <section class="bg-white py-10 md:py-14">
            <div class="max-w-7xl mx-auto px-4">
                <h2 class="text-2xl md:text-3xl font-bold text-gray-900 text-center">Реализованные однокомнатные
                    квартиры</h2>
                <!-- cards -->
                    ...
                    <?php foreach ($portfolio as $key => $value): ?>
                        <article class="border border-gray-200 rounded-2xl overflow-hidden bg-white shadow-sm" itemscope
                            ...
                            <meta itemprop="description"
                                content="Ремонт однокомнатной квартиры, срок: <?= htmlspecialchars($value['срок']); ?>, стоимость: <?= htmlspecialchars($value['цена']); ?>">
                            <div class="relative h-52">
                                <div class="swiper swiper-type-one w-full h-full">
                                    <div class="swiper-wrapper">
                                        <?php foreach ((new Functions())->getPhotos(htmlspecialchars((string) $value['текущая_папка'])) as $key => $img): ?>
