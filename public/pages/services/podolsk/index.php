...
$site = Functions::site();
$title = 'Ремонт квартир в Подольске — цены под ключ, гарантия 3 года | ПКвартира';
...
<head>
    ...
    <meta name="description" content="Ремонт квартир в Подольске под ключ. Цены от 8 000 ₽/м². Косметический, капитальный, дизайнерский ремонт. Фиксированная смета, гарантия 3 года. Бесплатный замер по Подольску.">
    <meta name="keywords" content="ремонт квартир Подольск, ремонт под ключ в Подольске, отделка квартир в Подольске, ремонт квартир в Подольск цены">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            ...
            {"@type": "Service","name": "Ремонт квартир в Подольске","provider": {"@type": "Organization","name": "ПКвартира"},"areaServed": {"@type": "City","name": "Подольск"}}
        ]
    }
    </script>
</head>
