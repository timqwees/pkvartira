...
$site = Functions::site();
$title = 'Ремонт квартир в Видном — цены под ключ, гарантия 3 года | ПКвартира';
...
<head>
    ...
    <meta name="description" content="Ремонт квартир в Видном под ключ. Цены от 8 000 ₽/м². Косметический, капитальный, дизайнерский ремонт. Фиксированная смета, гарантия 3 года. Бесплатный замер в Видном.">
    <meta name="keywords" content="ремонт квартир Видное, ремонт под ключ в Видном, отделка квартир в Видном, ремонт квартир в Видное цены">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            ...
            {"@type": "Service","name": "Ремонт квартир в Видном","provider": {"@type": "Organization","name": "ПКвартира"},"areaServed": {"@type": "City","name": "Видное"}}
        ]
    }
    </script>
</head>
