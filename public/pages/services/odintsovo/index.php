...
$site = Functions::site();
$title = 'Ремонт квартир в Одинцово — цены под ключ, гарантия 3 года | Проект Квартира';
