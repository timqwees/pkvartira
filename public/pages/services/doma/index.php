...
<head>
    ...
    <meta name="description"
        content="Ремонт домов и коттеджей под ключ в Москве и области. Фиксированная смета, сроки в договоре, гарантия 3 года. Бесплатный выезд инженера.">
    <meta name="keywords" content="ремонт дома под ключ, ремонт коттеджа, отделка дома, ремонт загородного дома Москва">
    ...
    <script type="application/ld+json">
  {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "description": "Ремонт домов и коттеджей под ключ. Фиксированные цены, реальные сроки, гарантия 3 года.",
        "isPartOf": {
          "@id": <?= json_encode($site['baseUrl'] . '#website', JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE); ?>
        },
        "about": {
      ...
      },
      {
        ...
        "description": "Профессиональный ремонт домов, коттеджей и коммерческих объектов в Москве и области",
        "provider": {
          "@id": <?= json_encode($site['baseUrl'] . '#organization', JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE); ?>
        },
      ...
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "Можно ли жить в доме во время ремонта?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Во время активных работ жить на объекте обычно неудобно: шум и пыль. Лучше на этот период перебраться в другое место."
            }
          },
          {
            "@type": "Question",
...
<body class="bg-white">
    ...
    <main class="pt-20 flex flex-col gap-0">
                ...
                <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <?php foreach ($prices as $price): ?>
                        <article
                            ...
                            <meta itemprop="name"
                                content="<?= htmlspecialchars($price['заголовок']); ?> ремонт дома под ключ">
        ...
        <section class="bg-white py-10 md:py-14">
            <div class="max-w-7xl mx-auto px-4">
                <h2 class="text-2xl md:text-3xl font-bold text-gray-900 text-center">Реализованные дома и коттеджи
                    под ключ</h2>
                <!-- cards -->
                    ...
                    <?php foreach ($portfolio as $key => $value): ?>
                        <article class="border border-gray-200 rounded-2xl overflow-hidden bg-white shadow-sm" itemscope
                            ...
                            <meta itemprop="description"
                                content="Ремонт дома, срок: <?= htmlspecialchars($value['срок']); ?>, стоимость: <?= htmlspecialchars($value['цена']); ?>">
                ...
                <div class="max-w-3xl mx-auto space-y-4">
                    <div class="border border-gray-200 rounded-xl overflow-hidden" itemscope itemprop="mainEntity"
                        ...
                        <button
                            ...
                            <span class="font-semibold text-gray-800" itemprop="name">Можно ли жить в доме во время
                                ремонта?</span>
                            <i class="fas fa-chevron-down text-blue-600"></i>
                        </button>
                        <div class="hidden p-4 text-gray-600 faq-content" itemscope itemprop="acceptedAnswer"
                            itemtype="https://schema.org/Answer">
                            <span itemprop="text">Во время активных работ жить на объекте обычно неудобно. Работы идут
                                по графику —
