...
$site = Functions::site();
$title = 'Ремонт евродвушки под ключ — цены в Москве 2026 | ПКвартира';
...
<head>
    ...
    <meta name="description" content="Ремонт евродвушки под ключ в Москве. Квартира-студия с кухней-гостиной. Зонирование, дизайн. Цена от 8 000 ₽/м². Гарантия 3 года.">
    <meta name="keywords" content="ремонт евродвушки, евродвушка под ключ, ремонт квартиры-студии двухкомнатной, кухня-гостиная ремонт, зонирование евродвушки">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="<?= htmlspecialchars($site['baseUrl'] . '/services/evro-dvushka'); ?>">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            {"@type": "BreadcrumbList","itemListElement": [
                ...
                {"@type": "ListItem","position": 2,"name": "Ремонт евродвушки","item": "<?= $site['baseUrl']; ?>/services/evro-dvushka"}
            ]},
            {"@type": "Service","name": "Ремонт евродвушки под ключ","provider": {"@type": "Organization","name": "ПКвартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
...
<main class="pt-20" style="padding-top:80px">
    <section class="relative bg-[#1f2937] text-white">
        ...
        <div class="relative container mx-auto px-4 max-w-6xl py-14 md:py-20">
            <h1 class="text-[28px] md:text-[40px] font-extrabold leading-tight" style="font-family:var(--font-heading)">Ремонт евродвушки под ключ</h1>
            <p class="mt-4 text-[17px] text-gray-300 max-w-2xl">Ремонт евродвушки — двухкомнатной квартиры-студии с просторной кухней-гостиной. Зонирование, дизайн, все виды работ. Цена от 8 000 ₽/м². Гарантия 3 года.</p>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h2 class="text-2xl font-bold text-[#111827]" style="font-family:var(--font-heading)">Особенности ремонта евродвушки</h2>
                    <p class="mt-4 text-[#4b5563] leading-relaxed">Евродвушка — это двухкомнатная квартира-студия с объединённой кухней-гостиной и изолированной спальней. Площадь кухни-гостиной может достигать 25–30 м², что открывает широкие возможности для дизайна и зонирования.</p>
                    <p class="mt-4 text-[#4b5563] leading-relaxed">При ремонте евродвушки важно грамотно организовать пространство: разделить зону готовки и отдыха, продумать освещение, подобрать отделочные материалы, которые выдержат высокую нагрузку в совмещённом пространстве.</p>
                    <ul class="mt-4 space-y-2">
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Зонирование кухни-гостиной с помощью перегородок, барных стоек, уровней пола и потолка</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Усиление вентиляции для кухонной зоны в большом помещении</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Комбинированное освещение для разных функциональных зон</li>
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Звукоизоляция спальни от кухни-гостиной</li>
                    </ul>
                </div>
                <div class="bg-[#f9fafb] rounded-xl p-6">
                    <h3 class="text-lg font-bold text-[#111827]">Цены на ремонт евродвушки</h3>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="max-w-lg mx-auto">
                <?php
$ctaFormId = 'evro-dvushka_cta';
$ctaFormTitle = 'Рассчитать стоимость ремонта евродвушки';
    ...
    <section class="py-12 bg-[#f9fafb]">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-6 max-w-3xl mx-auto space-y-3">
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Чем евродвушка отличается от обычной двушки?</summary><p class="mt-2 text-sm text-[#6b7280]">В евродвушке кухня и гостиная объединены в одно пространство, а спальня остаётся изолированной. Это создаёт эффект квартиры-студии с отдельной спальней.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Сколько стоит ремонт евродвушки?</summary><p class="mt-2 text-sm text-[#6b7280]">Цены от 8 000 ₽/м². Точная стоимость зависит от объёма работ, материалов и сложности зонирования. Рассчитаем смету после бесплатного замера.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Как зонировать кухню-гостиную?</summary><p class="mt-2 text-sm text-[#6b7280]">Используем барные стойки, разные уровни пола и потолка, декоративные перегородки, контрастные материалы отделки. Всё индивидуально по проекту дизайнера.</p></details>
            </div>
        </div>
    </section>
</main>
