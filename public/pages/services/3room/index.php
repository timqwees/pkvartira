...
$prices = [
    [
        ...
        'цена' => 'от 8 000 ₽',
        'цена_число' => '8000',
        'подзаголовок' => 'Итого для 70 м² - от 560 000 Р',
    ...
    [
        ...
        'цена' => 'от 13 000 ₽',
        'цена_число' => '13000',
        'подзаголовок' => 'Итого для 70 м² - от 910 000 Р',
    ...
    [
        ...
        'цена' => 'от 18 000 ₽',
        'цена_число' => '18000',
        'подзаголовок' => 'Итого для 70 м² - от 1 260 000 Р',
    ...
    <script type="application/ld+json">
  {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "description": "Ремонт трехкомнатных квартир под ключ в Москве. Фиксированные цены от 560 000 ₽, реальные сроки, гарантия 3 года.",
        "isPartOf": {
          "@id": <?= json_encode($site['baseUrl'] . '#website', JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE); ?>
        },
        "about": {
      ...
      },
      {
        ...
        "name": "Ремонт трехкомнатных квартир под ключ",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": "Ремонт трехкомнатной квартиры",
                ...
                <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <?php foreach ($prices as $price): ?>
                        <article
                            ...
                            <meta itemprop="name"
                                content="<?= htmlspecialchars($price['заголовок']); ?> ремонт трехкомнатной квартиры">
