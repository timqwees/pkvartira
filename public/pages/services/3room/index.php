...
$seo = Setting\Route\Function\Functions::seo([
    ...
    'description' => 'Профессиональный ремонт трёхкомнатной квартиры в москве — цена от 560 000 ₽ под ключ с гарантией 3 года в Москве. Качественный ремонт под ключ с гарантией.',
    'image' => $site['shareImageUrl'],
    'url' => $site['baseUrl'] . '/services/3room',
    'type' => 'website',
    'pageType' => 'Service',
    'breadcrumbs' => [
        ['name' => 'Главная', 'url' => $site['baseUrl'] . '/'],
        ['name' => 'Услуги', 'url' => $site['baseUrl'] . '/services/pod-klyuch'],
        ['name' => 'Ремонт трёхкомнатной квартиры в Москве — цена от 560 000 ₽ под ключ с гарантией 3 года', 'url' => $site['baseUrl'] . '/services/3room'],
    ],
    'schema' => [
...
<head>
    ...
    <meta name="keywords" content="Ремонт трёхкомнатной квартиры в Москве — цена от 560 000 ₽ под ключ с гарантией 3 года, 3room, ремонт под ключ, ПКвартира, ремонт под ключ, ПКвартира">
    ...
    <main class="pt-20 flex flex-col gap-8 pb-16">
            ...
            <div class="container mx-auto px-4 max-w-4xl">
                <nav aria-label="breadcrumb" class="text-sm text-gray-600 mb-4">
                    <ol class="flex flex-wrap items-center gap-2">
                        ...
                        <li class="text-gray-400">/</li>
                        <li class="text-gray-900 font-medium">Ремонт трёхкомнатной квартиры в Москве — цена от 560 000 ₽ под ключ с гарантией 3 года</li>
                    </ol>
                </nav>
                <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Ремонт трёхкомнатной квартиры в Москве — цена от 560 000 ₽ под ключ с гарантией 3 года</h1>
                <p class="text-gray-600 text-lg leading-relaxed">
                    Профессиональный ремонт трёхкомнатной квартиры в москве — цена от 560 000 ₽ под ключ с гарантией 3 года в Москве. Качественный ремонт под ключ с гарантией.
                </p>
            </div>
        </section>
        ...
        <section class="container mx-auto px-4 max-w-4xl reveal">
            <div class="bg-white rounded-2xl border border-gray-200 p-6 md:p-8 shadow-sm">
                <h2 class="text-2xl font-bold text-gray-900 mb-4">Что входит в Ремонт трёхкомнатной квартиры в Москве — цена от 560 000 ₽ под ключ с гарантией 3 года</h2>
                <p class="text-gray-600 mb-6 leading-relaxed">
                    Полный комплекс работ по ремонт трёхкомнатной квартиры в москве — цена от 560 000 ₽ под ключ с гарантией 3 года под ключ. Вы получаете готовый результат без скрытых платежей и с гарантией 3 года.
                </p>
