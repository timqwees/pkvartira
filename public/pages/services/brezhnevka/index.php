...
$site = Functions::site();
$title = 'Ремонт квартир в брежневке под ключ — цены в Москве 2026 | ПКвартира';
...
<head>
    ...
    <meta name="description" content="Ремонт квартир в брежневке под ключ в Москве. Панельные дома 60–80х годов, типовые планировки. Косметический от 8 000 ₽/м², капитальный от 13 000 ₽/м². Гарантия 3 года.">
    <meta name="keywords" content="ремонт квартир в брежневке, ремонт брежневки под ключ, ремонт брежневки цены, отделка брежневки Москва">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="<?= htmlspecialchars($site['baseUrl'] . '/services/brezhnevka'); ?>">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            {"@type": "BreadcrumbList","itemListElement": [
                ...
                {"@type": "ListItem","position": 2,"name": "Ремонт в брежневке","item": "<?= $site['baseUrl']; ?>/services/brezhnevka"}
            ]},
            {"@type": "Service","name": "Ремонт квартир в брежневке","provider": {"@type": "Organization","name": "ПКвартира"},"areaServed": {"@type": "City","name": "Москва"}}
        ]
    }
    </script>
</head>
...
<main class="pt-20" style="padding-top:80px">
    <section class="relative bg-[#1f2937] text-white">
        ...
        <div class="relative container mx-auto px-4 max-w-6xl py-14 md:py-20">
            <h1 class="text-[28px] md:text-[40px] font-extrabold leading-tight" style="font-family:var(--font-heading)">Ремонт квартир в брежневке под ключ</h1>
            <p class="mt-4 text-[17px] text-gray-300 max-w-2xl">Профессиональный ремонт квартир в брежневке под ключ в Москве. Панельные дома 60–80х годов, типовые планировки. Цены от 8 000 ₽/м², гарантия 3 года.</p>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    <h2 class="text-2xl font-bold text-[#111827]" style="font-family:var(--font-heading)">Особенности ремонта в брежневке</h2>
                    <p class="mt-4 text-[#4b5563] leading-relaxed">Брежневские дома — это панельные многоэтажки 60–80х годов. Они объединяют черты хрущёвок и более поздних серий: типовые планировки, средние потолки, относительно тонкие стены. При ремонте важно усилить шумоизоляцию и обновить инженерные коммуникации.</p>
                    <ul class="mt-4 space-y-2">
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Тонкие панельные стены — необходима шумоизоляция</li>
                        ...
                        <li class="flex items-start gap-2 text-[#4b5563]"><span class="text-orange-500 mt-1">•</span> Средние потолки — правильный выбор светильников</li>
                ...
                <div class="bg-[#f9fafb] rounded-xl p-6">
                    <h3 class="text-lg font-bold text-[#111827]">Цены на ремонт в брежневке</h3>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4 max-w-6xl">
            <div class="max-w-lg mx-auto">
                <?php
$ctaFormId = 'brezhnevka_cta';
$ctaFormTitle = 'Рассчитать стоимость ремонта в брежневке';
$ctaFormSubtitle = 'Бесплатный расчёт за 5 минут';
$ctaButtonText = 'Рассчитать';
$ctaShowName = true;
$ctaHiddenCity = 'brezhnevka';
$ctaExpandable = false;
    ...
    <section class="py-12 bg-[#f9fafb]">
        <div class="container mx-auto px-4 max-w-6xl">
            ...
            <div class="mt-6 max-w-3xl mx-auto space-y-3">
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Сколько стоит ремонт квартиры в брежневке?</summary><p class="mt-2 text-sm text-[#6b7280]">Косметический ремонт от 8 000 ₽/м², капитальный — от 13 000 ₽/м². Стоимость зависит от состояния панелей, объёма замены коммуникаций и выбранных материалов.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Нужна ли шумоизоляция при ремонте?</summary><p class="mt-2 text-sm text-[#6b7280]">Да, в брежневках стены тонкие, и шумоизоляция значительно повышает комфорт. Рекомендуем её при капитальном и дизайнерском ремонте.</p></details>
                <details class="bg-white rounded-xl p-4"><summary class="font-semibold text-[#111827] cursor-pointer">Можно ли сделать перепланировку?</summary><p class="mt-2 text-sm text-[#6b7280]">Возможность перепланировки зависит от типа стен. Мы проведём экспертизу и предложим оптимальные решения для увеличения полезного пространства.</p></details>
            </div>
        </div>
    </section>
</main>
