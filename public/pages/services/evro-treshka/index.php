...
$seo = Setting\Route\Function\Functions::seo([
    'title' => 'Ремонт евротрешки под ключ — цены в Москве 2026',
    'description' => 'Ремонт евротрешки под ключ в Москве. Трёхкомнатная квартира-студия с просторной кухней-гостиной. Зонирование, дизайн. Цена от 8 000 ₽/м². Гарантия 3 года.',
    'image' => $site['shareImageUrl'],
    'url' => $site['baseUrl'] . '/services/evro-treshka',
    'type' => 'website',
    'pageType' => 'Service',
    'breadcrumbs' => [
        ['name' => 'Главная', 'url' => $site['baseUrl'] . '/'],
        ['name' => 'Услуги', 'url' => $site['baseUrl'] . '/services/pod-klyuch'],
        ['name' => 'Ремонт евротрешки под ключ — цены в Москве 2026', 'url' => $site['baseUrl'] . '/services/evro-treshka'],
    ],
    'schema' => [
...
<head>
    ...
    <meta name="keywords" content="Ремонт евротрешки под ключ — цены в Москве 2026, evro-treshka, ремонт под ключ, ПКвартира, ремонт под ключ, ПКвартира">
    ...
    <main class="pt-20 flex flex-col gap-8 pb-16">
            ...
            <div class="container mx-auto px-4 max-w-4xl">
                <nav aria-label="breadcrumb" class="text-sm text-gray-600 mb-4">
                    <ol class="flex flex-wrap items-center gap-2">
                        ...
                        <li class="text-gray-400">/</li>
                        <li class="text-gray-900 font-medium">Ремонт евротрешки под ключ — цены в Москве 2026</li>
                    </ol>
                </nav>
                <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Ремонт евротрешки под ключ — цены в Москве 2026</h1>
                <p class="text-gray-600 text-lg leading-relaxed">
                    Ремонт евротрешки под ключ в Москве. Трёхкомнатная квартира-студия с просторной кухней-гостиной. Зонирование, дизайн. Цена от 8 000 ₽/м². Гарантия 3 года.
                </p>
            </div>
        </section>
        ...
        <section class="container mx-auto px-4 max-w-4xl reveal">
            <div class="bg-white rounded-2xl border border-gray-200 p-6 md:p-8 shadow-sm">
                <h2 class="text-2xl font-bold text-gray-900 mb-4">Что входит в Ремонт евротрешки под ключ — цены в Москве 2026</h2>
                <p class="text-gray-600 mb-6 leading-relaxed">
                    Полный комплекс работ по ремонт евротрешки под ключ — цены в москве 2026 под ключ. Вы получаете готовый результат без скрытых платежей и с гарантией 3 года.
                </p>
