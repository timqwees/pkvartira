...
<body class="bg-white">
    ...
    <main class="pt-20 flex flex-col gap-0">
        ...
        <section class="bg-white py-10 md:py-14">
            <div class="max-w-7xl mx-auto px-4">
                <h2 class="text-2xl md:text-3xl font-bold text-gray-900 text-center">Реализованные четырехкомнатные
                    квартиры</h2>
                <!-- cards -->
                    ...
                    <?php foreach ($portfolio as $key => $value): ?>
                        <article class="border border-gray-200 rounded-2xl overflow-hidden bg-white shadow-sm" itemscope
                            ...
                            <meta itemprop="description"
                                content="Ремонт четырехкомнатной квартиры, срок: <?= htmlspecialchars($value['срок']); ?>, стоимость: <?= htmlspecialchars($value['цена']); ?>">
