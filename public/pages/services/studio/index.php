...
$prices = [
    [
        ...
        'цена' => 'от 8 000 ₽',
        'цена_число' => '8000',
        'подзаголовок' => 'Итого для 25 м² - от 200 000 Р',
    ...
    [
        ...
        'цена' => 'от 13 000 ₽',
        'цена_число' => '13000',
        'подзаголовок' => 'Итого для 25 м² - от 325 000 Р',
    ...
    [
        ...
        'цена' => 'от 18 000 ₽',
        'цена_число' => '18000',
        'подзаголовок' => 'Итого для 25 м² - от 450 000 Р',
...
$portfolio = (new Functions())->getPortfolio('public/assets/images/portfolio-photos/studio');
?>
<!DOCTYPE html>
<html lang="ru">
...
<head>
    ...
    <meta name="description"
        content="Ремонт квартир-студий под ключ в Москве от 200 000 ₽. Фиксированные цены, реальные сроки, гарантия 3 года. Выезд инженера бесплатно.">
    <meta name="keywords"
    ...
    <meta property="og:description"
        content="Ремонт квартир-студий под ключ в Москве от 200 000 ₽. Фиксированные цены, реальные сроки, гарантия 3 года.">
    <meta property="og:url" content="<?= htmlspecialchars($site['baseUrl'] . '/services/studio'); ?>">
    ...
    <meta name="twitter:description"
        content="Ремонт квартир-студий под ключ от 200 000 ₽. Фиксированные цены, реальные сроки, гарантия 3 года.">
    ...
    <script type="application/ld+json">
  {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "description": "Ремонт квартир-студий под ключ в Москве. Фиксированные цены от 200 000 ₽, реальные сроки, гарантия 3 года.",
        "isPartOf": {
          "@id": <?= json_encode($site['baseUrl'] . '#website', JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE); ?>
        },
        "about": {
      ...
      },
      {
        ...
        "name": "Ремонт квартир-студий под ключ",
...
<body class="bg-white">
    ...
    <main class="pt-20 flex flex-col gap-0">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    <div>
                        ...
                        <div class="mt-6 flex flex-col sm:flex-row gap-3">
                            ...
                            <a href="#price"
                                class="cta-button cta-button border border-gray-300 bg-white hover:bg-gray-50 text-gray-900 px-6 py-3 rounded-lg font-semibold transition text-center">
                                Смотреть цены
                            </a>
                        </div>
        ...
        <section class="bg-white py-10 md:py-14">
            <div class="max-w-7xl mx-auto px-4">
                <h2 class="text-2xl md:text-3xl font-bold text-gray-900 text-center">Реализованные квартиры-студии</h2>
                <!-- cards -->
                    ...
                    <?php foreach ($portfolio as $key => $value): ?>
                        <article class="border border-gray-200 rounded-2xl overflow-hidden bg-white shadow-sm" itemscope
                            ...
                            <meta itemprop="description"
                                content="Ремонт квартиры-студии, срок: <?= htmlspecialchars($value['срок']); ?>, стоимость: <?= htmlspecialchars($value['цена']); ?>">
