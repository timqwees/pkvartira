...
$site = Functions::site();
$title = 'Ремонт квартир в Раменском — цены под ключ, гарантия 3 года | ПКвартира';
...
<head>
    ...
    <meta name="description" content="Ремонт квартир в Раменском под ключ. Цены от 8 000 ₽/м². Косметический, капитальный, дизайнерский ремонт. Фиксированная смета, гарантия 3 года. Замер в Раменском бесплатно.">
    <meta name="keywords" content="ремонт квартир Раменское, ремонт под ключ в Раменском, отделка квартир в Раменском, ремонт квартир в Раменское цены">
    ...
    <script type="application/ld+json">
    {
        ...
        "@graph": [
            ...
            {"@type": "Service","name": "Ремонт квартир в Раменском","provider": {"@type": "Organization","name": "ПКвартира"},"areaServed": {"@type": "City","name": "Раменское"}}
        ]
    }
    </script>
</head>
