...
$seo = Setting\Route\Functions\TheFunction::seo([
    ...
    'breadcrumbs' => [
        ...
        ['name' => 'О компании', 'url' => $site['baseUrl'] . '/about'],
    ],
]);
?>
<!DOCTYPE html>
                ...
                <div class="flex flex-col gap-4 md:gap-8">
                    ...
                    <div class="flex flex-col md:flex-row gap-8 items-stretch justify-stretch">
                        ...
                        <div class="relative flex-1">
                            <img src="<?= \Setting\Route\Functions\TheFunction::asset('/public/assets/images/about/team.jpg') ?>" alt="Наша команда"
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide cursor-pointer text-center group">
                            <div class="relative overflow-hidden rounded-xl mb-4">
                                <img src="<?= \Setting\Route\Functions\TheFunction::asset('/public/assets/images/about/team/1.jpg') ?>" alt="Владимир Соболев"
                        ...
                        <div class="swiper-slide cursor-pointer text-center group">
                            <div class="relative overflow-hidden rounded-xl mb-4">
                                <img src="<?= \Setting\Route\Functions\TheFunction::asset('/public/assets/images/about/team/2.jpg') ?>" alt="Семён Серебренников"
                                    class="w-full h-48 object-cover group-hover:scale-105 transition duration-300">
                            </div>
                        ...
                        <div class="swiper-slide cursor-pointer text-center group">
                            <div class="relative overflow-hidden rounded-xl mb-4">
                                <img src="<?= \Setting\Route\Functions\TheFunction::asset('/public/assets/images/about/team/3.jpg') ?>" alt="Илья Архипов"
                                    class="w-full h-48 object-cover group-hover:scale-105 transition duration-300">
                            </div>
                        ...
                        <div class="swiper-slide cursor-pointer text-center group">
                            <div class="relative overflow-hidden rounded-xl mb-4">
                                <img src="<?= \Setting\Route\Functions\TheFunction::asset('/public/assets/images/about/team/4.jpg') ?>" alt="Роман Сайферт"
                                    class="w-full h-48 object-cover group-hover:scale-105 transition duration-300">
                            </div>
                        ...
                        <div class="swiper-slide cursor-pointer text-center group">
                            <div class="relative overflow-hidden rounded-xl mb-4">
                                <img src="<?= \Setting\Route\Functions\TheFunction::asset('/public/assets/images/about/team/6.jpg') ?>" alt="Иван Филиппов"
                                    class="w-full h-48 object-cover group-hover:scale-105 transition duration-300">
                            </div>
            ...
            <div class="container mx-auto px-4 max-w-6xl">
                ...
                <div class="flex flex-col lg:flex-row gap-8 items-start">
                    ...
                    <div class="flex justify-center items-center">
                        <img src="<?= \Setting\Route\Functions\TheFunction::asset('/public/assets/images/pages/about/contract.jpg') ?>" alt="Документы и договор"
                ...
                <div class="swiper swiper-type-6">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide flex items-center justify-center">
                            <img src="<?= \Setting\Route\Functions\TheFunction::asset('/public/assets/images/partners/mail.svg') ?>" class="h-16 md:h-20 lg:h-24 object-contain" alt="russia 24">
                        </div>
                        <div class="swiper-slide flex items-center justify-center">
                            <img src="<?= \Setting\Route\Functions\TheFunction::asset('/public/assets/images/partners/rus24.svg') ?>" class="h-16 md:h-20 lg:h-24 object-contain" alt="russia 24">
                        </div>
                        <div class="swiper-slide flex items-center justify-center">
                            <img src="<?= \Setting\Route\Functions\TheFunction::asset('/public/assets/images/partners/2gis.svg') ?>" class="h-16 md:h-20 lg:h-24 object-contain" alt="2gis">
                        </div>
                        <div class="swiper-slide flex items-center justify-center">
                            <img src="<?= \Setting\Route\Functions\TheFunction::asset('/public/assets/images/partners/mail.svg') ?>" class="h-16 md:h-20 lg:h-24 object-contain" alt="russia 24">
                        </div>
