...
$seo = Setting\Route\Function\Functions::seo([
    'title' => 'Калькулятор площади квартиры и комнаты онлайн — расчёт м² стен, пола, потолка',
    'description' => 'Онлайн-калькулятор площади квартиры: посчитайте м² комнаты, стен, пола и потолка за 10 секунд. Формулы для прямоугольных и сложных помещений. Перевод площади в стоимость ремонта. Бесплатно.',
...
<head>
    ...
    <meta name="keywords"
        content="калькулятор площади, посчитать квадратные метры, площадь комнаты, расчет площади стен, м2 калькулятор, площадь квартиры онлайн">
