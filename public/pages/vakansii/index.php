...
$seo = TheFunction::seo([
    ...
    'keywords' => 'работа Проект Квартира, ПКвартира вакансии, работа маляр плиточник сантехник электрик штукатур плотник каменщик мастер универсал замерщик сметчик прораб Москва, вакансии с еженедельной оплатой, работа с проживанием Москва',
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  var suggestData = [
    ...
    {q:'Прораб-инженер', cat:'universal', label:'Управление 150–250k'},
    {q:'Замерщик', cat:'universal', label:'Продажи от 300k'},
    {q:'Прораб', cat:'universal', label:'Управление от 200k'},
  ];
