...
class Routes extends Network
{
     ...
     * ---
     * <b>Примеры:</b>
     * - <code>self::file('/files/{path:.+}', '/public/uploads')</code>
     *   URL /files/images/photo.jpg → отдаст файл /public/uploads/images/photo.jpg
     *
     * ---
     * @param string $path    URI с плейсхолдером пути, например '/files/{path:.+}'
     *
     * @return void
     */
    public static function file(string $path): void
    {
        self::addRoute('GET', $path, function ($path) {
